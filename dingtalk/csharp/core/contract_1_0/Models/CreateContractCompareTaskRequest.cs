...
{
    public class CreateContractCompareTaskRequest : TeaModel {
        [NameInMap("comparativeFile")]
        [Validation(Required=false)]
        public CreateContractCompareTaskRequestComparativeFile ComparativeFile { get; set; }
        public class CreateContractCompareTaskRequestComparativeFile : TeaModel {
            [NameInMap("fileId")]
            [Validation(Required=false)]
        ...
        [Validation(Required=false)]
        public CreateContractCompareTaskRequestStandardFile StandardFile { get; set; }
        public class CreateContractCompareTaskRequestStandardFile : TeaModel {
            [NameInMap("fileId")]
            [Validation(Required=false)]
            public string FileId { get; set; }
