...
{
    public class CreateCourseRequest : TeaModel {
        /// <summary>
        /// <b>Example:</b>
        /// <para>{&quot;&quot;}</para>
        /// </summary>
        ...
        [Validation(Required=false)]
        public List<CreateCourseRequestTeacherList> TeacherList { get; set; }
        public class CreateCourseRequestTeacherList : TeaModel {
            /// <summary>
            /// <b>Example:</b>
            /// <para>李老师</para>
            /// </summary>
