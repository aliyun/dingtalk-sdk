...
{
    public class CreateEduLlmModelReqRequest : TeaModel {
        [NameInMap("chatMessageModelList")]
        [Validation(Required=false)]
        public List<CreateEduLlmModelReqRequestChatMessageModelList> ChatMessageModelList { get; set; }
        public class CreateEduLlmModelReqRequestChatMessageModelList : TeaModel {
            [NameInMap("contentList")]
            [Validation(Required=false)]
            public List<CreateEduLlmModelReqRequestChatMessageModelListContentList> ContentList { get; set; }
            public class CreateEduLlmModelReqRequestChatMessageModelListContentList : TeaModel {
                [NameInMap("imageModel")]
                [Validation(Required=false)]
                public CreateEduLlmModelReqRequestChatMessageModelListContentListImageModel ImageModel { get; set; }
                public class CreateEduLlmModelReqRequestChatMessageModelListContentListImageModel : TeaModel {
                    [NameInMap("detail")]
                    [Validation(Required=false)]
