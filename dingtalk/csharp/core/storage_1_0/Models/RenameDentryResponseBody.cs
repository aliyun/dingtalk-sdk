...
{
    public class RenameDentryResponseBody : TeaModel {
        /// <summary>
        /// 文件信息
        /// </summary>
        [NameInMap("dentry")]
        [Validation(Required=false)]
        public RenameDentryResponseBodyDentry Dentry { get; set; }
        public class RenameDentryResponseBodyDentry : TeaModel {
            /// <summary>
            ...
            [Validation(Required=false)]
            public RenameDentryResponseBodyDentryProperties Properties { get; set; }
            public class RenameDentryResponseBodyDentryProperties : TeaModel {
                /// <summary>
                /// 文件是否只读
                /// </summary>
                [NameInMap("readOnly")]
