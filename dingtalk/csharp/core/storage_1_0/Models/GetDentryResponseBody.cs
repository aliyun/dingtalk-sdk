...
{
    public class GetDentryResponseBody : TeaModel {
        /// <summary>
        /// 文件(夹)信息
        /// </summary>
        [NameInMap("dentry")]
        [Validation(Required=false)]
        public GetDentryResponseBodyDentry Dentry { get; set; }
        public class GetDentryResponseBodyDentry : TeaModel {
            /// <summary>
            ...
            [Validation(Required=false)]
            public GetDentryResponseBodyDentryProperties Properties { get; set; }
            public class GetDentryResponseBodyDentryProperties : TeaModel {
                /// <summary>
                /// 文件是否只读
                /// </summary>
                [NameInMap("readOnly")]
