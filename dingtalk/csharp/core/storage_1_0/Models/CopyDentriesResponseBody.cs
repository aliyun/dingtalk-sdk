...
{
    public class CopyDentriesResponseBody : TeaModel {
        [NameInMap("resultItems")]
        [Validation(Required=false)]
        public List<CopyDentriesResponseBodyResultItems> ResultItems { get; set; }
        public class CopyDentriesResponseBodyResultItems : TeaModel {
            /// <summary>
            /// <b>Example:</b>
            /// <para>true</para>
            /// </summary>
