...
namespace AlibabaCloud.SDK.Dingtalkcrm_1_0.Models
{
    public class UpdateMetaModelFieldRequest : TeaModel {
        ...
        public class UpdateMetaModelFieldRequestFieldDTOList : TeaModel {
            ...
            [NameInMap("props")]
            [Validation(Required=false)]
            public UpdateMetaModelFieldRequestFieldDTOListProps Props { get; set; }
            public class UpdateMetaModelFieldRequestFieldDTOListProps : TeaModel {
                [NameInMap("align")]
                [Validation(Required=false)]
                ...
                [NameInMap("options")]
                [Validation(Required=false)]
                public List<UpdateMetaModelFieldRequestFieldDTOListPropsOptions> Options { get; set; }
                public class UpdateMetaModelFieldRequestFieldDTOListPropsOptions : TeaModel {
                    [NameInMap("key")]
                    [Validation(Required=false)]
