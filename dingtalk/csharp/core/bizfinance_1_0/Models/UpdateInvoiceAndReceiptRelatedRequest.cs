...
namespace AlibabaCloud.SDK.Dingtalkbizfinance_1_0.Models
{
    public class UpdateInvoiceAndReceiptRelatedRequest : TeaModel {
        ...
        public class UpdateInvoiceAndReceiptRelatedRequestGeneralInvoiceVO : TeaModel {
            ...
            [Validation(Required=false)]
            public UpdateInvoiceAndReceiptRelatedRequestGeneralInvoiceVOGeneralInvoiceDetailVO GeneralInvoiceDetailVO { get; set; }
            public class UpdateInvoiceAndReceiptRelatedRequestGeneralInvoiceVOGeneralInvoiceDetailVO : TeaModel {
                /// <summary>
                /// 金额
                /// </summary>
                [NameInMap("amount")]
            ...
            [Validation(Required=false)]
            public UpdateInvoiceAndReceiptRelatedRequestGeneralInvoiceVOSecondHandCarInvoiceDetail SecondHandCarInvoiceDetail { get; set; }
            public class UpdateInvoiceAndReceiptRelatedRequestGeneralInvoiceVOSecondHandCarInvoiceDetail : TeaModel {
                /// <summary>
                /// 金额
                /// </summary>
                [NameInMap("amount")]
            ...
            [Validation(Required=false)]
            public UpdateInvoiceAndReceiptRelatedRequestGeneralInvoiceVOUsedVehicleSaleDetailVO UsedVehicleSaleDetailVO { get; set; }
            public class UpdateInvoiceAndReceiptRelatedRequestGeneralInvoiceVOUsedVehicleSaleDetailVO : TeaModel {
                /// <summary>
                /// 经营、拍卖单位
                /// </summary>
            ...
            [Validation(Required=false)]
            public UpdateInvoiceAndReceiptRelatedRequestGeneralInvoiceVOVehicleSaleDetailVO VehicleSaleDetailVO { get; set; }
            public class UpdateInvoiceAndReceiptRelatedRequestGeneralInvoiceVOVehicleSaleDetailVO : TeaModel {
                /// <summary>
                /// 品牌
                /// </summary>
                [NameInMap("brand")]
