...
namespace AlibabaCloud.SDK.Dingtalkbizfinance_1_0.Models
{
    public class UpdateInvoiceIgnoreStatusRequest : TeaModel {
        ...
        public class UpdateInvoiceIgnoreStatusRequestGeneralInvoiceVO : TeaModel {
            ...
            [Validation(Required=false)]
            public List<UpdateInvoiceIgnoreStatusRequestGeneralInvoiceVOGeneralInvoiceDetailVOList> GeneralInvoiceDetailVOList { get; set; }
            ...
            [Validation(Required=false)]
            public List<UpdateInvoiceIgnoreStatusRequestGeneralInvoiceVOSecondHandCarInvoiceDetailList> SecondHandCarInvoiceDetailList { get; set; }
            public class UpdateInvoiceIgnoreStatusRequestGeneralInvoiceVOSecondHandCarInvoiceDetailList : TeaModel {
                public string Amount { get; set; }
            ...
            [Validation(Required=false)]
            public List<UpdateInvoiceIgnoreStatusRequestGeneralInvoiceVOUsedVehicleSaleDetailVOList> UsedVehicleSaleDetailVOList { get; set; }
            public class UpdateInvoiceIgnoreStatusRequestGeneralInvoiceVOUsedVehicleSaleDetailVOList : TeaModel {
            ...
            [Validation(Required=false)]
            public List<UpdateInvoiceIgnoreStatusRequestGeneralInvoiceVOVehicleSaleDetailVOList> VehicleSaleDetailVOList { get; set; }
            public class UpdateInvoiceIgnoreStatusRequestGeneralInvoiceVOVehicleSaleDetailVOList : TeaModel {
