...
{
    public class UpdateApplyReceiptAndInvoiceRelatedRequest : TeaModel {
        [NameInMap("generalInvoiceVOList")]
        [Validation(Required=false)]
        public List<UpdateApplyReceiptAndInvoiceRelatedRequestGeneralInvoiceVOList> GeneralInvoiceVOList { get; set; }
        public class UpdateApplyReceiptAndInvoiceRelatedRequestGeneralInvoiceVOList : TeaModel {
            ...
            [Validation(Required=false)]
            public List<UpdateApplyReceiptAndInvoiceRelatedRequestGeneralInvoiceVOListGeneralInvoiceDetailVOList> GeneralInvoiceDetailVOList { get; set; }
            public class UpdateApplyReceiptAndInvoiceRelatedRequestGeneralInvoiceVOListGeneralInvoiceDetailVOList : TeaModel {
                [NameInMap("amount")]
                [Validation(Required=false)]
                public string Amount { get; set; }
            ...
            [Validation(Required=false)]
            public List<UpdateApplyReceiptAndInvoiceRelatedRequestGeneralInvoiceVOListSecondHandCarInvoiceDetailList> SecondHandCarInvoiceDetailList { get; set; }
            public class UpdateApplyReceiptAndInvoiceRelatedRequestGeneralInvoiceVOListSecondHandCarInvoiceDetailList : TeaModel {
                [NameInMap("amount")]
                [Validation(Required=false)]
                public string Amount { get; set; }
            ...
            [Validation(Required=false)]
            public List<UpdateApplyReceiptAndInvoiceRelatedRequestGeneralInvoiceVOListUsedVehicleSaleDetailVOList> UsedVehicleSaleDetailVOList { get; set; }
            public class UpdateApplyReceiptAndInvoiceRelatedRequestGeneralInvoiceVOListUsedVehicleSaleDetailVOList : TeaModel {
            ...
            [Validation(Required=false)]
            public List<UpdateApplyReceiptAndInvoiceRelatedRequestGeneralInvoiceVOListVehicleSaleDetailVOList> VehicleSaleDetailVOList { get; set; }
            public class UpdateApplyReceiptAndInvoiceRelatedRequestGeneralInvoiceVOListVehicleSaleDetailVOList : TeaModel {
                [NameInMap("brand")]
                [Validation(Required=false)]
