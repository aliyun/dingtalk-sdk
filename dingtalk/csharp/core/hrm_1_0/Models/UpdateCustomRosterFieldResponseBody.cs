...
{
    public class UpdateCustomRosterFieldResponseBody : TeaModel {
        ...
        [NameInMap("result")]
        [Validation(Required=false)]
        public UpdateCustomRosterFieldResponseBodyResult Result { get; set; }
        public class UpdateCustomRosterFieldResponseBodyResult : TeaModel {
            ...
            [Validation(Required=false)]
            public string NumberDecimalPlace { get; set; }
