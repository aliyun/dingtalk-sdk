...
{
    public class AddCustomRosterFieldResponseBody : TeaModel {
        ...
        [NameInMap("result")]
        [Validation(Required=false)]
        public AddCustomRosterFieldResponseBodyResult Result { get; set; }
        public class AddCustomRosterFieldResponseBodyResult : TeaModel {
