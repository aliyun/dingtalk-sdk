...
{
    public class UpdateSceneGroupRequest : TeaModel {
        /// <summary>
        /// <b>Example:</b>
        /// <para>http://***.png</para>
        /// </summary>
        ...
        [Validation(Required=false)]
        public UpdateSceneGroupRequestManagementOptions ManagementOptions { get; set; }
        public class UpdateSceneGroupRequestManagementOptions : TeaModel {
            ...
            [Validation(Required=false)]
            public int? PluginCustomizeVerify { get; set; }
