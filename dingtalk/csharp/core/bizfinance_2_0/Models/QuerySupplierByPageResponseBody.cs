...
namespace AlibabaCloud.SDK.Dingtalkbizfinance_2_0.Models
{
    public class QuerySupplierByPageResponseBody : TeaModel {
        ...
        public class QuerySupplierByPageResponseBodyList : TeaModel {
            ...
            [Validation(Required=false)]
            public List<QuerySupplierByPageResponseBodyListCustomFormDataList> CustomFormDataList { get; set; }
            public class QuerySupplierByPageResponseBodyListCustomFormDataList : TeaModel {
                [NameInMap("bizAlias")]
                [Validation(Required=false)]
