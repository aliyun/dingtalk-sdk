...
{
    public class SpecialRuleBatchReceiverRequest : TeaModel {
        [NameInMap("batchNo")]
        ...
        [NameInMap("data")]
        [Validation(Required=false)]
        public List<SpecialRuleBatchReceiverRequestData> Data { get; set; }
        public class SpecialRuleBatchReceiverRequestData : TeaModel {
            [NameInMap("atAccount")]
            [Validation(Required=false)]
            ...
            [NameInMap("attrs")]
            [Validation(Required=false)]
            public SpecialRuleBatchReceiverRequestDataAttrs Attrs { get; set; }
            public class SpecialRuleBatchReceiverRequestDataAttrs : TeaModel {
            ...
            [Validation(Required=false)]
            public Dictionary<string, Dictionary<string, object>> PrivateContent { get; set; }
