...
public class CreateGroupHeaders extends TeaModel {
    ...
    public CreateGroupHeaders setOperationSource(String operationSource) {
    ...
    public CreateGroupHeaders setXAcsDingtalkAccessToken(String xAcsDingtalkAccessToken) {
