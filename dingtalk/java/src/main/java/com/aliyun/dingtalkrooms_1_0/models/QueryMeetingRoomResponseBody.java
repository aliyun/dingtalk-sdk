...
public class QueryMeetingRoomResponseBody extends TeaModel {
    ...
    public static class QueryMeetingRoomResponseBodyResultRoomLocation extends TeaModel {
        ...
        public QueryMeetingRoomResponseBodyResultRoomLocation setLatitude(String latitude) {
        ...
        public QueryMeetingRoomResponseBodyResultRoomLocation setLongitude(String longitude) {
