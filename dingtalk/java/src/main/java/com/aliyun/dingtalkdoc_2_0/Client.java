...
public class Client extends com.aliyun.teaopenapi.Client {
     ...
     */
    public CopyDocWithAppAuthResponse copyDocWithAppAuthWithOptions(CopyDocWithAppAuthRequest request, CopyDocWithAppAuthHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.operatorId)) {
            body.put("operatorId", request.operatorId);
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.sourceDentryUuid)) {
            body.put("sourceDentryUuid", request.sourceDentryUuid);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.targetParentDentryUuid)) {
            body.put("targetParentDentryUuid", request.targetParentDentryUuid);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.targetPreDentryUuid)) {
            body.put("targetPreDentryUuid", request.targetPreDentryUuid);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "CopyDocWithAppAuth"),
            new TeaPair("version", "doc_2.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v2.0/doc/app/dentries/copy"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new CopyDocWithAppAuthResponse());
    }
     ...
     * @return CopyDocWithAppAuthResponse
     */
    public CopyDocWithAppAuthResponse copyDocWithAppAuth(CopyDocWithAppAuthRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public CreateShortcutForMigrateResponse createShortcutForMigrateWithOptions(CreateShortcutForMigrateRequest request, CreateShortcutForMigrateHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.operatorId)) {
            body.put("operatorId", request.operatorId);
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.sourceResourceId)) {
            body.put("sourceResourceId", request.sourceResourceId);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.sourceResourceType)) {
            body.put("sourceResourceType", request.sourceResourceType);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.targetResourceId)) {
            body.put("targetResourceId", request.targetResourceId);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.targetResourceName)) {
            body.put("targetResourceName", request.targetResourceName);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.targetResourceType)) {
            body.put("targetResourceType", request.targetResourceType);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "CreateShortcutForMigrate"),
            new TeaPair("version", "doc_2.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v2.0/doc/resource/shortcut/createV2"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new CreateShortcutForMigrateResponse());
    }
     ...
     * @return CreateShortcutForMigrateResponse
     */
    public CreateShortcutForMigrateResponse createShortcutForMigrate(CreateShortcutForMigrateRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public DocExportByDelegatedPermissionResponse docExportByDelegatedPermissionWithOptions(String dentryUuid, DocExportByDelegatedPermissionRequest request, DocExportByDelegatedPermissionHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "DocExportByDelegatedPermission"),
            new TeaPair("version", "doc_2.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v2.0/doc/me/dentries/" + dentryUuid + "/export"),
            new TeaPair("method", "GET"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new DocExportByDelegatedPermissionResponse());
    }
     ...
     * @return DocExportByDelegatedPermissionResponse
     */
    public DocExportByDelegatedPermissionResponse docExportByDelegatedPermission(String dentryUuid, DocExportByDelegatedPermissionRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public GetOrgOrWebOpenDocContentResponse getOrgOrWebOpenDocContentWithOptions(String dentryUuid, GetOrgOrWebOpenDocContentRequest request, GetOrgOrWebOpenDocContentHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.generateCp)) {
            query.put("generateCp", request.generateCp);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "GetOrgOrWebOpenDocContent"),
            new TeaPair("version", "doc_2.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v2.0/doc/me/dentries/" + dentryUuid + "/contents"),
            new TeaPair("method", "GET"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new GetOrgOrWebOpenDocContentResponse());
    }
     ...
     * @return GetOrgOrWebOpenDocContentResponse
     */
    public GetOrgOrWebOpenDocContentResponse getOrgOrWebOpenDocContent(String dentryUuid, GetOrgOrWebOpenDocContentRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public GetUuidByIdOrUrlResponse getUuidByIdOrUrlWithOptions(GetUuidByIdOrUrlRequest request, GetUuidByIdOrUrlHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.idOrUrl)) {
            query.put("idOrUrl", request.idOrUrl);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "GetUuidByIdOrUrl"),
            new TeaPair("version", "doc_2.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v2.0/doc/documents/queryDentryUuid"),
            new TeaPair("method", "GET"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new GetUuidByIdOrUrlResponse());
    }
     ...
     * @return GetUuidByIdOrUrlResponse
     */
    public GetUuidByIdOrUrlResponse getUuidByIdOrUrl(GetUuidByIdOrUrlRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public QueryExportTaskResponse queryExportTaskWithOptions(QueryExportTaskRequest request, QueryExportTaskHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.operatorId)) {
            query.put("operatorId", request.operatorId);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "QueryExportTask"),
            new TeaPair("version", "doc_2.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v2.0/doc/me/export/task/query"),
            new TeaPair("method", "GET"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new QueryExportTaskResponse());
    }
     ...
     * @return QueryExportTaskResponse
     */
    public QueryExportTaskResponse queryExportTask(QueryExportTaskRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public SubmitExportJobResponse submitExportJobWithOptions(SubmitExportJobRequest request, SubmitExportJobHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "SubmitExportJob"),
            new TeaPair("version", "doc_2.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v2.0/doc/me/export/submit"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new SubmitExportJobResponse());
    }
     ...
     * @return SubmitExportJobResponse
     */
    public SubmitExportJobResponse submitExportJob(SubmitExportJobRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
