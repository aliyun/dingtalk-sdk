...
public class QueryTasksV3ResponseBody extends TeaModel {
    ...
    public static class QueryTasksV3ResponseBodyResult extends TeaModel {
        ...
        public QueryTasksV3ResponseBodyResult setAncestorIds(java.util.List<String> ancestorIds) {
        ...
        public QueryTasksV3ResponseBodyResult setIsArchived(Boolean isArchived) {
        ...
        public QueryTasksV3ResponseBodyResult setParentTaskId(String parentTaskId) {
        ...
        public QueryTasksV3ResponseBodyResult setPriority(Integer priority) {
        ...
        public QueryTasksV3ResponseBodyResult setProgress(Integer progress) {
        ...
        public QueryTasksV3ResponseBodyResult setRecurrence(java.util.List<String> recurrence) {
        ...
        public QueryTasksV3ResponseBodyResult setSfcId(String sfcId) {
            this.sfcId = sfcId;
            return this;
        }
        ...
        public QueryTasksV3ResponseBodyResult setSprintId(String sprintId) {
        ...
        public QueryTasksV3ResponseBodyResult setStageId(String stageId) {
        ...
        public QueryTasksV3ResponseBodyResult setStartDate(String startDate) {
        ...
        public QueryTasksV3ResponseBodyResult setStoryPoint(String storyPoint) {
        ...
        public QueryTasksV3ResponseBodyResult setTagIds(java.util.List<String> tagIds) {
            this.tagIds = tagIds;
            return this;
        }
        ...
        public QueryTasksV3ResponseBodyResult setTasklistId(String tasklistId) {
        ...
        public QueryTasksV3ResponseBodyResult setTfsId(String tfsId) {
            this.tfsId = tfsId;
            return this;
        }
        ...
        public QueryTasksV3ResponseBodyResult setUniqueId(String uniqueId) {
        ...
        public QueryTasksV3ResponseBodyResult setVisible(String visible) {
