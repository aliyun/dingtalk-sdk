...
public class Client extends com.aliyun.teaopenapi.Client {
     ...
     */
    public EnableWorkflowResponse enableWorkflowWithOptions(String baseId, String flowId, EnableWorkflowRequest request, EnableWorkflowHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.operatorId)) {
            query.put("operatorId", request.operatorId);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            ...
            new TeaPair("version", "notable_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/notable/bases/" + baseId + "/workflows/" + flowId + "/enable"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new EnableWorkflowResponse());
    }
     ...
     * @return EnableWorkflowResponse
     */
    public EnableWorkflowResponse enableWorkflow(String baseId, String flowId, EnableWorkflowRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public ExecuteImportResponse executeImportWithOptions(String baseId, ExecuteImportRequest request, ExecuteImportHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.operatorId)) {
            query.put("operatorId", request.operatorId);
        ...
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.appendConfig)) {
            body.put("appendConfig", request.appendConfig);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.encryption)) {
            body.put("encryption", request.encryption);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.importId)) {
            body.put("importId", request.importId);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ExecuteImport"),
            new TeaPair("version", "notable_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/notable/bases/" + baseId + "/import/execute"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new ExecuteImportResponse());
    }
     ...
     * @return ExecuteImportResponse
     */
    public ExecuteImportResponse executeImport(String baseId, ExecuteImportRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public GetImportEncryptPublicKeyResponse getImportEncryptPublicKeyWithOptions(GetImportEncryptPublicKeyRequest request, GetImportEncryptPublicKeyHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "GetImportEncryptPublicKey"),
            new TeaPair("version", "notable_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/notable/import/encryptPublicKey"),
            new TeaPair("method", "GET"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new GetImportEncryptPublicKeyResponse());
    }
     ...
     * @return GetImportEncryptPublicKeyResponse
     */
    public GetImportEncryptPublicKeyResponse getImportEncryptPublicKey(GetImportEncryptPublicKeyRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public ListWorkflowsResponse listWorkflowsWithOptions(String baseId, ListWorkflowsRequest request, ListWorkflowsHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.operatorId)) {
            query.put("operatorId", request.operatorId);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            ...
            new TeaPair("version", "notable_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/notable/bases/" + baseId + "/workflows"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
     ...
     * @return ListWorkflowsResponse
     */
    public ListWorkflowsResponse listWorkflows(String baseId, ListWorkflowsRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public MarkExternalAuthControlledSheetResponse markExternalAuthControlledSheetWithOptions(String baseId, String sheetIdOrName, MarkExternalAuthControlledSheetRequest request, MarkExternalAuthControlledSheetHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.clientToken)) {
            query.put("clientToken", request.clientToken);
        ...
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.externalAuthType)) {
            body.put("externalAuthType", request.externalAuthType);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "MarkExternalAuthControlledSheet"),
            new TeaPair("version", "notable_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/notable/bases/" + baseId + "/sheets/" + sheetIdOrName + "/externalAuth/mark"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new MarkExternalAuthControlledSheetResponse());
    }
     ...
     * @return MarkExternalAuthControlledSheetResponse
     */
    public MarkExternalAuthControlledSheetResponse markExternalAuthControlledSheet(String baseId, String sheetIdOrName, MarkExternalAuthControlledSheetRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public PrepareImportUploadResponse prepareImportUploadWithOptions(String baseId, PrepareImportUploadRequest request, PrepareImportUploadHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.operatorId)) {
            query.put("operatorId", request.operatorId);
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.fileExtension)) {
            body.put("fileExtension", request.fileExtension);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "PrepareImportUpload"),
            new TeaPair("version", "notable_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/notable/bases/" + baseId + "/import/uploadUrl"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new PrepareImportUploadResponse());
    }
     ...
     * @return PrepareImportUploadResponse
     */
    public PrepareImportUploadResponse prepareImportUpload(String baseId, PrepareImportUploadRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public QueryChangedRecordIdsByClientTokenResponse queryChangedRecordIdsByClientTokenWithOptions(String baseId, QueryChangedRecordIdsByClientTokenRequest request, QueryChangedRecordIdsByClientTokenHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.operatorId)) {
            query.put("operatorId", request.operatorId);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "QueryChangedRecordIdsByClientToken"),
            new TeaPair("version", "notable_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/notable/bases/" + baseId + "/changedRecordIds/query"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new QueryChangedRecordIdsByClientTokenResponse());
    }
     ...
     * @return QueryChangedRecordIdsByClientTokenResponse
     */
    public QueryChangedRecordIdsByClientTokenResponse queryChangedRecordIdsByClientToken(String baseId, QueryChangedRecordIdsByClientTokenRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public QueryExternalAuthControlledSheetsResponse queryExternalAuthControlledSheetsWithOptions(String baseId, QueryExternalAuthControlledSheetsRequest request, QueryExternalAuthControlledSheetsHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.externalAuthType)) {
            query.put("externalAuthType", request.externalAuthType);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "QueryExternalAuthControlledSheets"),
            new TeaPair("version", "notable_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/notable/bases/" + baseId + "/externalAuth/sheets"),
            new TeaPair("method", "GET"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new QueryExternalAuthControlledSheetsResponse());
    }
     ...
     * @return QueryExternalAuthControlledSheetsResponse
     */
    public QueryExternalAuthControlledSheetsResponse queryExternalAuthControlledSheets(String baseId, QueryExternalAuthControlledSheetsRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public QueryImportStatusResponse queryImportStatusWithOptions(String baseId, QueryImportStatusRequest request, QueryImportStatusHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.importId)) {
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "QueryImportStatus"),
            new TeaPair("version", "notable_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/notable/bases/" + baseId + "/import/status"),
            new TeaPair("method", "GET"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new QueryImportStatusResponse());
    }
     ...
     * @return QueryImportStatusResponse
     */
    public QueryImportStatusResponse queryImportStatus(String baseId, QueryImportStatusRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public TruncateSheetRecordsResponse truncateSheetRecordsWithOptions(String baseId, String sheetIdOrName, TruncateSheetRecordsRequest request, TruncateSheetRecordsHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.operatorId)) {
            query.put("operatorId", request.operatorId);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "TruncateSheetRecords"),
            new TeaPair("version", "notable_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/notable/bases/" + baseId + "/sheets/" + sheetIdOrName + "/records/truncate"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new TruncateSheetRecordsResponse());
    }
     ...
     * @return TruncateSheetRecordsResponse
     */
    public TruncateSheetRecordsResponse truncateSheetRecords(String baseId, String sheetIdOrName, TruncateSheetRecordsRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public UnmarkExternalAuthControlledSheetResponse unmarkExternalAuthControlledSheetWithOptions(String baseId, String sheetIdOrName, UnmarkExternalAuthControlledSheetRequest request, UnmarkExternalAuthControlledSheetHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.clientToken)) {
            query.put("clientToken", request.clientToken);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "UnmarkExternalAuthControlledSheet"),
            new TeaPair("version", "notable_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/notable/bases/" + baseId + "/sheets/" + sheetIdOrName + "/externalAuth/mark"),
            new TeaPair("method", "DELETE"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new UnmarkExternalAuthControlledSheetResponse());
    }
     ...
     * @return UnmarkExternalAuthControlledSheetResponse
     */
    public UnmarkExternalAuthControlledSheetResponse unmarkExternalAuthControlledSheet(String baseId, String sheetIdOrName, UnmarkExternalAuthControlledSheetRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
