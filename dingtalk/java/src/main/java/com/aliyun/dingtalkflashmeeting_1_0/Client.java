...
public class Client extends com.aliyun.teaopenapi.Client {
     ...
     */
    public CopyLinkToWorkspaceResponse copyLinkToWorkspaceWithOptions(CopyLinkToWorkspaceRequest request, CopyLinkToWorkspaceHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.parentNodeKey)) {
            body.put("parentNodeKey", request.parentNodeKey);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.shanhuiKey)) {
            body.put("shanhuiKey", request.shanhuiKey);
        }
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.workspaceKey)) {
            body.put("workspaceKey", request.workspaceKey);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "CopyLinkToWorkspace"),
            new TeaPair("version", "flashmeeting_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/flashmeeting/meetings/copyLinkToWorkspace"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new CopyLinkToWorkspaceResponse());
    }
     ...
     * @return CopyLinkToWorkspaceResponse
     */
    public CopyLinkToWorkspaceResponse copyLinkToWorkspace(CopyLinkToWorkspaceRequest request) throws Exception {
     ...
     */
    public ExportShanhuiToDocResponse exportShanhuiToDocWithOptions(ExportShanhuiToDocRequest request, ExportShanhuiToDocHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.contentEnums)) {
            body.put("contentEnums", request.contentEnums);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ExportShanhuiToDoc"),
            new TeaPair("version", "flashmeeting_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/flashmeeting/meetings/export"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new ExportShanhuiToDocResponse());
    }
     ...
     * @return ExportShanhuiToDocResponse
     */
    public ExportShanhuiToDocResponse exportShanhuiToDoc(ExportShanhuiToDocRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public GetShanhuiAttachmentsResponse getShanhuiAttachmentsWithOptions(GetShanhuiAttachmentsRequest request, GetShanhuiAttachmentsHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.shanhuiKey)) {
            body.put("shanhuiKey", request.shanhuiKey);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "GetShanhuiAttachments"),
            new TeaPair("version", "flashmeeting_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/flashmeeting/meetings/getShanhuiAttachments"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new GetShanhuiAttachmentsResponse());
    }
     ...
     * @return GetShanhuiAttachmentsResponse
     */
    public GetShanhuiAttachmentsResponse getShanhuiAttachments(GetShanhuiAttachmentsRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
