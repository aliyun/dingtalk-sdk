...
public class Client extends com.aliyun.teaopenapi.Client {
     ...
     */
    public ProcessHhOemUpdateResponse processHhOemUpdateWithOptions(ProcessHhOemUpdateRequest request, ProcessHhOemUpdateHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.bindOemApp)) {
            body.put("bindOemApp", request.bindOemApp);
        }
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.useOemApp)) {
            body.put("useOemApp", request.useOemApp);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ProcessHhOemUpdate"),
            new TeaPair("version", "attendance_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/attendance/oemApps"),
            new TeaPair("method", "PUT"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new ProcessHhOemUpdateResponse());
    }
     ...
     * @return ProcessHhOemUpdateResponse
     */
    public ProcessHhOemUpdateResponse processHhOemUpdate(ProcessHhOemUpdateRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
