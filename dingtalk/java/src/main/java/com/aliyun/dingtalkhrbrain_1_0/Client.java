...
public class Client extends com.aliyun.teaopenapi.Client {
     ...
     */
    public HrbrainLabelEmpDeleteResponse hrbrainLabelEmpDeleteWithOptions(HrbrainLabelEmpDeleteRequest request, HrbrainLabelEmpDeleteHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.labelCode)) {
            body.put("labelCode", request.labelCode);
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.workNos)) {
            body.put("workNos", request.workNos);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "HrbrainLabelEmpDelete"),
            new TeaPair("version", "hrbrain_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/hrbrain/labels/delete"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new HrbrainLabelEmpDeleteResponse());
    }
     ...
     * @return HrbrainLabelEmpDeleteResponse
     */
    public HrbrainLabelEmpDeleteResponse hrbrainLabelEmpDelete(HrbrainLabelEmpDeleteRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
