...
public class Client extends com.aliyun.teaopenapi.Client {
     ...
     */
    public OptRecordWhiteAccountResponse optRecordWhiteAccountWithOptions(OptRecordWhiteAccountRequest tmpReq, OptRecordWhiteAccountHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "OptRecordWhiteAccount"),
            new TeaPair("version", "conference_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/conference/videoConferences/enterpriseSetting/record/whiteAccount"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new OptRecordWhiteAccountResponse());
    }
     ...
     * @return OptRecordWhiteAccountResponse
     */
    public OptRecordWhiteAccountResponse optRecordWhiteAccount(OptRecordWhiteAccountRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public QueryOrgConferenceListResponse queryOrgConferenceListWithOptions(QueryOrgConferenceListRequest request, QueryOrgConferenceListHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.maxResults)) {
            query.put("maxResults", request.maxResults);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "QueryOrgConferenceList"),
            new TeaPair("version", "conference_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/conference/orgConferences"),
            new TeaPair("method", "GET"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new QueryOrgConferenceListResponse());
    }
     ...
     * @return QueryOrgConferenceListResponse
     */
    public QueryOrgConferenceListResponse queryOrgConferenceList(QueryOrgConferenceListRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public SetSubtitleEventResponse setSubtitleEventWithOptions(String conferenceId, SetSubtitleEventRequest request, SetSubtitleEventHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "SetSubtitleEvent"),
            new TeaPair("version", "conference_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/conference/videoConferences/" + conferenceId + "/subtitleEvents"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new SetSubtitleEventResponse());
    }
     ...
     * @return SetSubtitleEventResponse
     */
    public SetSubtitleEventResponse setSubtitleEvent(String conferenceId, SetSubtitleEventRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
