...
public class UpdateGroupTagRequest extends TeaModel {
    ...
    public UpdateGroupTagRequest setDingIsvOrgId(Long dingIsvOrgId) {
    ...
    public UpdateGroupTagRequest setDingOrgId(Long dingOrgId) {
    ...
    public UpdateGroupTagRequest setDingSuiteKey(String dingSuiteKey) {
    ...
    public UpdateGroupTagRequest setDingTokenGrantType(Long dingTokenGrantType) {
