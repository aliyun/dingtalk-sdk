...
public class Client extends com.aliyun.teaopenapi.Client {
     ...
     */
    public PurchaseMixViewResponse purchaseMixViewWithOptions(PurchaseMixViewRequest request, PurchaseMixViewHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.combineActivityId)) {
            body.put("combineActivityId", request.combineActivityId);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.createOrder)) {
            body.put("createOrder", request.createOrder);
        }
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.mergeOrderName)) {
            body.put("mergeOrderName", request.mergeOrderName);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.needModelTypeList)) {
            body.put("needModelTypeList", request.needModelTypeList);
        }
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.objType)) {
            body.put("objType", request.objType);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.orderParamMap)) {
            body.put("orderParamMap", request.orderParamMap);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.outerTradeCode)) {
            body.put("outerTradeCode", request.outerTradeCode);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.outerTradeType)) {
            body.put("outerTradeType", request.outerTradeType);
        }
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.unPay)) {
            body.put("unPay", request.unPay);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "PurchaseMixView"),
            new TeaPair("version", "trade_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/trade/purchase/mixView"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new PurchaseMixViewResponse());
    }
     ...
     * @return PurchaseMixViewResponse
     */
    public PurchaseMixViewResponse purchaseMixView(PurchaseMixViewRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
