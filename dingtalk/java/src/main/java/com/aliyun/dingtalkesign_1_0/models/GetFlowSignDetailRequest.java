...
public class GetFlowSignDetailRequest extends TeaModel {
    ...
    public GetFlowSignDetailRequest setDingCorpId(String dingCorpId) {
    ...
    public GetFlowSignDetailRequest setDingIsvAccessToken(String dingIsvAccessToken) {
    ...
    public GetFlowSignDetailRequest setDingSuiteKey(String dingSuiteKey) {
