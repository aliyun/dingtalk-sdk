...
public class GetCropStatusRequest extends TeaModel {
    ...
    public GetCropStatusRequest setDingCorpId(String dingCorpId) {
    ...
    public GetCropStatusRequest setDingIsvAccessToken(String dingIsvAccessToken) {
    ...
    public GetCropStatusRequest setDingSuiteKey(String dingSuiteKey) {
