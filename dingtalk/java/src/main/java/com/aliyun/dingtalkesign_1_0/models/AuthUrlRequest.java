...
public class AuthUrlRequest extends TeaModel {
    ...
    public AuthUrlRequest setDingCorpId(String dingCorpId) {
    ...
    public AuthUrlRequest setDingIsvAccessToken(String dingIsvAccessToken) {
    ...
    public AuthUrlRequest setDingSuiteKey(String dingSuiteKey) {
