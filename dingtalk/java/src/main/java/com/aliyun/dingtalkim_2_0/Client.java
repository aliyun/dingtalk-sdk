...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public GroupManagerDeviceMarketResponse groupManagerDeviceMarketWithOptions(java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        return TeaModel.toModel(this.doROARequestWithForm(params.action, params.version, params.protocol, params.method, params.authType, params.pathname, params.bodyType, req, runtime), new GroupManagerDeviceMarketResponse());
    }
