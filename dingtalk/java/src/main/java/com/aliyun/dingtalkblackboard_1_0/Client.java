...
public class Client extends com.aliyun.teaopenapi.Client {
     ...
     */
    public GetBlackboardResponse getBlackboardWithOptions(GetBlackboardRequest request, GetBlackboardHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "GetBlackboard"),
            new TeaPair("version", "blackboard_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/blackboard/get_blackboard"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new GetBlackboardResponse());
    }
     ...
     * @return GetBlackboardResponse
     */
    public GetBlackboardResponse getBlackboard(GetBlackboardRequest request) throws Exception {
