...
public class RespondEventHeaders extends TeaModel {
    ...
    public RespondEventHeaders setDingOrgId(String dingOrgId) {
    ...
    public RespondEventHeaders setDingUid(String dingUid) {
    ...
    public RespondEventHeaders setDingAccessTokenType(String dingAccessTokenType) {
