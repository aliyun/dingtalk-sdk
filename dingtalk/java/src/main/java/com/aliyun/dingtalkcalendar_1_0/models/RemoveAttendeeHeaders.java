...
public class RemoveAttendeeHeaders extends TeaModel {
    ...
    public RemoveAttendeeHeaders setDingOrgId(String dingOrgId) {
    ...
    public RemoveAttendeeHeaders setDingUid(String dingUid) {
    ...
    public RemoveAttendeeHeaders setDingAccessTokenType(String dingAccessTokenType) {
