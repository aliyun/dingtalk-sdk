...
public class GetEventHeaders extends TeaModel {
    ...
    public GetEventHeaders setDingOrgId(String dingOrgId) {
    ...
    public GetEventHeaders setDingUid(String dingUid) {
    ...
    public GetEventHeaders setDingAccessTokenType(String dingAccessTokenType) {
    ...
    public GetEventHeaders setXAcsDingtalkAccessToken(String xAcsDingtalkAccessToken) {
