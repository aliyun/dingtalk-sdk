...
public class AddMeetingRoomsHeaders extends TeaModel {
    ...
    public AddMeetingRoomsHeaders setXClientToken(String xClientToken) {
    ...
    public AddMeetingRoomsHeaders setXAcsDingtalkAccessToken(String xAcsDingtalkAccessToken) {
