...
public class DeleteEventHeaders extends TeaModel {
    ...
    public DeleteEventHeaders setDingOrgId(String dingOrgId) {
    ...
    public DeleteEventHeaders setDingUid(String dingUid) {
    ...
    public DeleteEventHeaders setDingAccessTokenType(String dingAccessTokenType) {
