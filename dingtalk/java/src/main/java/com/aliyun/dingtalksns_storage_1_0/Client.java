...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public ListExpiredResponse listExpiredWithOptions(ListExpiredRequest request, ListExpiredHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        return TeaModel.toModel(this.doROARequest("ListExpired", "snsStorage_1.0", "HTTP", "POST", "AK", "/v1.0/snsStorage/conversations/expiredFileLists/query", "json", req, runtime), new ListExpiredResponse());
    }
