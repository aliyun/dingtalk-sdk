...
public class Client extends com.aliyun.teaopenapi.Client {
     ...
     */
    public ExclusiveModelCompleteServiceResponse exclusiveModelCompleteServiceWithOptions(ExclusiveModelCompleteServiceRequest request, ExclusiveModelCompleteServiceHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ExclusiveModelCompleteService"),
            new TeaPair("version", "aiPaaS_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/aiPaaS/ai/complete"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new ExclusiveModelCompleteServiceResponse());
    }
     ...
     * @return ExclusiveModelCompleteServiceResponse
     */
    public ExclusiveModelCompleteServiceResponse exclusiveModelCompleteService(ExclusiveModelCompleteServiceRequest request) throws Exception {
