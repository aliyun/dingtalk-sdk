...
public class Client extends com.aliyun.teaopenapi.Client {
     ...
     */
    public KickoffByDeviceIdResponse kickoffByDeviceIdWithOptions(KickoffByDeviceIdRequest request, KickoffByDeviceIdHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.openDeviceId)) {
            body.put("openDeviceId", request.openDeviceId);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "KickoffByDeviceId"),
            new TeaPair("version", "oauth2_1.0"),
            new TeaPair("protocol", "HTTP"),
            new TeaPair("pathname", "/v1.0/oauth2/kickoffByDeviceId"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "none"),
        ...
        return TeaModel.toModel(this.execute(params, req, runtime), new KickoffByDeviceIdResponse());
    }
     ...
     * @return KickoffByDeviceIdResponse
     */
    public KickoffByDeviceIdResponse kickoffByDeviceId(KickoffByDeviceIdRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
