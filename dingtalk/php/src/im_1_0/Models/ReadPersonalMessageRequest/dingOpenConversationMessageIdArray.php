...
namespace AlibabaCloud\SDK\Dingtalk\Vim_1_0\Models\ReadPersonalMessageRequest;

use AlibabaCloud\Tea\Model;

class dingOpenConversationMessageIdArray extends Model
{
    /**
     ...
     * @param array $map
     *
     * @return dingOpenConversationMessageIdArray
     */
