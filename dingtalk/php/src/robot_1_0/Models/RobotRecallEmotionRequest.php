...
use AlibabaCloud\SDK\Dingtalk\Vrobot_1_0\Models\RobotRecallEmotionRequest\textEmotion;
use AlibabaCloud\Tea\Model;

class RobotRecallEmotionRequest extends Model
{
    /**
     * @example OK
     *
     ...
     * @param array $map
     *
     * @return RobotRecallEmotionRequest
     */
