...
namespace AlibabaCloud\SDK\Dingtalk\Vattendance_1_0\Models\GetCheckinRecordByUserResponseBody\result;

use AlibabaCloud\SDK\Dingtalk\Vattendance_1_0\Models\GetCheckinRecordByUserResponseBody\result\pageList\customDataList;
...
class pageList extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->checkinType) {
            $res['checkinType'] = $this->checkinType;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['checkinType'])) {
            $model->checkinType = $map['checkinType'];
        }
