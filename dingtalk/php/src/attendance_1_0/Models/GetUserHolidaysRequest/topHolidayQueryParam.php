...
namespace AlibabaCloud\SDK\Dingtalk\Vattendance_1_0\Models\GetUserHolidaysRequest;

use AlibabaCloud\Tea\Model;

class topHolidayQueryParam extends Model
{
    /**
     * @description 员工列表，staffId
     *
     * @var string[]
     */
    public $userIds;
