...
namespace AlibabaCloud\SDK\Dingtalk\Vservice_group_1_0\Models\GetInstancesByIdsResponseBody;

use AlibabaCloud\Tea\Model;

class customFormInstanceResponseList extends Model
{
    /**
     * @var string
     */
     ...
     * @param array $map
     *
     * @return customFormInstanceResponseList
     */
