...
use AlibabaCloud\SDK\Dingtalk\Vblackboard_1_0\Models\QueryBlackboardReadUnReadResponseBody\users;
use AlibabaCloud\Tea\Model;

class QueryBlackboardReadUnReadResponseBody extends Model
{
    /**
     * @var string
     */
     ...
     * @param array $map
     *
     * @return QueryBlackboardReadUnReadResponseBody
     */
