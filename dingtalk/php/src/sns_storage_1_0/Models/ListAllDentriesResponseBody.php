...
use AlibabaCloud\SDK\Dingtalk\Vsns_storage_1_0\Models\ListAllDentriesResponseBody\dentries;
use AlibabaCloud\Tea\Model;

class ListAllDentriesResponseBody extends Model
{
    /**
     * @description 文件列表
     * 50
     ...
     * @param array $map
     *
     * @return ListAllDentriesResponseBody
     */
