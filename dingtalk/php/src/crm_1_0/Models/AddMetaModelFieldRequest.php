...
use AlibabaCloud\SDK\Dingtalk\Vcrm_1_0\Models\AddMetaModelFieldRequest\fieldDTOList;
use AlibabaCloud\Tea\Model;

class AddMetaModelFieldRequest extends Model
{
    /**
     ...
     * @param array $map
     *
     * @return AddMetaModelFieldRequest
     */
