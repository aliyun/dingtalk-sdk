...
class Dingtalk extends OpenApiClient
{
    ...
    public function rePushSuiteTicketWithOptions($request, $headers, $runtime)
    {
        ...
        return RePushSuiteTicketResponse::fromMap($this->doROARequestWithForm($params->action, $params->version, $params->protocol, $params->method, $params->authType, $params->pathname, $params->bodyType, $req, $runtime));
    }
