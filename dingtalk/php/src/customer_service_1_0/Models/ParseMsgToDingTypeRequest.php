...
use AlibabaCloud\SDK\Dingtalk\Vcustomer_service_1_0\Models\ParseMsgToDingTypeRequest\body;
use AlibabaCloud\Tea\Model;

class ParseMsgToDingTypeRequest extends Model
{
    /**
     ...
     * @param array $map
     *
     * @return ParseMsgToDingTypeRequest
     */
