...
namespace AlibabaCloud\SDK\Dingtalk\Vproject_integration_1_0\Models;

use AlibabaCloud\Tea\Model;

class SendSingleInteractiveCardHeaders extends Model
{
     ...
     * @param array $map
     *
     * @return SendSingleInteractiveCardHeaders
     */
