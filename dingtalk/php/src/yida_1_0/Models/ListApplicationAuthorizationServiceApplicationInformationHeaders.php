...
class ListApplicationAuthorizationServiceApplicationInformationHeaders extends Model
{
     ...
     * @param array $map
     *
     * @return ListApplicationAuthorizationServiceApplicationInformationHeaders
     */
