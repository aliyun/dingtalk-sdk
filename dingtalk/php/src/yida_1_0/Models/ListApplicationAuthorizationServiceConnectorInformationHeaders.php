...
class ListApplicationAuthorizationServiceConnectorInformationHeaders extends Model
{
     ...
     * @param array $map
     *
     * @return ListApplicationAuthorizationServiceConnectorInformationHeaders
     */
