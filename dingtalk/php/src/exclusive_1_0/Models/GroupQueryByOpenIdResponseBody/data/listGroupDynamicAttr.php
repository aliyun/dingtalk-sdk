...
namespace AlibabaCloud\SDK\Dingtalk\Vexclusive_1_0\Models\GroupQueryByOpenIdResponseBody\data;

use AlibabaCloud\Tea\Model;

class listGroupDynamicAttr extends Model
{
    /**
     * @var string
     */
