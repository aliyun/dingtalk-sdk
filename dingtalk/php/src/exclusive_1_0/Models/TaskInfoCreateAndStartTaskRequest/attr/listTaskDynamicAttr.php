...
namespace AlibabaCloud\SDK\Dingtalk\Vexclusive_1_0\Models\TaskInfoCreateAndStartTaskRequest\attr;

use AlibabaCloud\Tea\Model;

class listTaskDynamicAttr extends Model
{
    /**
     * @var string
     */
