...
namespace AlibabaCloud\SDK\Dingtalk\Vexclusive_1_0\Models\SpecialRuleBatchReceiverRequest;

use AlibabaCloud\SDK\Dingtalk\Vexclusive_1_0\Models\SpecialRuleBatchReceiverRequest\data\attrs;
...
class data extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->privateContent) {
            $res['privateContent'] = $this->privateContent;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['privateContent'])) {
            $model->privateContent = $map['privateContent'];
        }
