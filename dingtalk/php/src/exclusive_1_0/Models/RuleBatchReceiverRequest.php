...
use AlibabaCloud\SDK\Dingtalk\Vexclusive_1_0\Models\RuleBatchReceiverRequest\data;
use AlibabaCloud\Tea\Model;

class RuleBatchReceiverRequest extends Model
{
    /**
     * @var string
     */
     ...
     * @param array $map
     *
     * @return RuleBatchReceiverRequest
     */
