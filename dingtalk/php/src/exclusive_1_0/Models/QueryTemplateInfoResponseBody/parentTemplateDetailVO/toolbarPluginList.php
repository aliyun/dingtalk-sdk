...
namespace AlibabaCloud\SDK\Dingtalk\Vexclusive_1_0\Models\QueryTemplateInfoResponseBody\parentTemplateDetailVO;

use AlibabaCloud\Tea\Model;

class toolbarPluginList extends Model
{
    /**
     * @var string
     */
