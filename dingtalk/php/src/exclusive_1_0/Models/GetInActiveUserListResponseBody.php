...
use AlibabaCloud\SDK\Dingtalk\Vexclusive_1_0\Models\GetInActiveUserListResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class GetInActiveUserListResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return GetInActiveUserListResponseBody
     */
