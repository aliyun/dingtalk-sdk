...
namespace AlibabaCloud\SDK\Dingtalk\Vteam_sphere_1_0\Models\CreateTaskResponseBody\result;

use AlibabaCloud\SDK\Dingtalk\Vteam_sphere_1_0\Models\CreateTaskResponseBody\result\customfields\value;
use AlibabaCloud\Tea\Model;

class customfields extends Model
{
    /**
     * @example 625bcxdxxxxxx
     *
     * @var string
     */
