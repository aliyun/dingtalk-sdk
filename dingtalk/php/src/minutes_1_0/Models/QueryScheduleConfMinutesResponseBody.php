...
use AlibabaCloud\SDK\Dingtalk\Vminutes_1_0\Models\QueryScheduleConfMinutesResponseBody\minutesDetails;
use AlibabaCloud\Tea\Model;

class QueryScheduleConfMinutesResponseBody extends Model
{
    /**
     * @var minutesDetails[]
     */
     ...
     * @param array $map
     *
     * @return QueryScheduleConfMinutesResponseBody
     */
