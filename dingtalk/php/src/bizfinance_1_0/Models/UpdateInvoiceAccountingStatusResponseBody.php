...
use AlibabaCloud\SDK\Dingtalk\Vbizfinance_1_0\Models\UpdateInvoiceAccountingStatusResponseBody\failInvoices;
use AlibabaCloud\Tea\Model;

class UpdateInvoiceAccountingStatusResponseBody extends Model
{
    /**
     * @description 返回结果
     *
     ...
     * @param array $map
     *
     * @return UpdateInvoiceAccountingStatusResponseBody
     */
