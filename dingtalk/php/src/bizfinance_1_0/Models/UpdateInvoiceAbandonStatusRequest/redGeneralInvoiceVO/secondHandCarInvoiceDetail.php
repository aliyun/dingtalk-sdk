...
namespace AlibabaCloud\SDK\Dingtalk\Vbizfinance_1_0\Models\UpdateInvoiceAbandonStatusRequest\redGeneralInvoiceVO;

use AlibabaCloud\Tea\Model;

class secondHandCarInvoiceDetail extends Model
{
    /**
     * @description 金额
     *
     ...
     * @param array $map
     *
     * @return secondHandCarInvoiceDetail
     */
