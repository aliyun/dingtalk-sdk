...
namespace AlibabaCloud\SDK\Dingtalk\Vbizfinance_1_0\Models\UpdateInvoiceIgnoreStatusRequest;

use AlibabaCloud\SDK\Dingtalk\Vbizfinance_1_0\Models\UpdateInvoiceIgnoreStatusRequest\generalInvoiceVO\generalInvoiceDetailVOList;
use AlibabaCloud\SDK\Dingtalk\Vbizfinance_1_0\Models\UpdateInvoiceIgnoreStatusRequest\generalInvoiceVO\secondHandCarInvoiceDetail;
use AlibabaCloud\SDK\Dingtalk\Vbizfinance_1_0\Models\UpdateInvoiceIgnoreStatusRequest\generalInvoiceVO\usedVehicleSaleDetailVO;
use AlibabaCloud\SDK\Dingtalk\Vbizfinance_1_0\Models\UpdateInvoiceIgnoreStatusRequest\generalInvoiceVO\vehicleSaleDetailVO;
...
class generalInvoiceVO extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->generalInvoiceDetailVOList) {
            $res['generalInvoiceDetailVOList'] = null !== $this->generalInvoiceDetailVOList ? $this->generalInvoiceDetailVOList->toMap() : null;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['generalInvoiceDetailVOList'])) {
            $model->generalInvoiceDetailVOList = generalInvoiceDetailVOList::fromMap($map['generalInvoiceDetailVOList']);
        }
