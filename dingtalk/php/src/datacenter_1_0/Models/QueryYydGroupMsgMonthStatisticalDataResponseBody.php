...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryYydGroupMsgMonthStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryYydGroupMsgMonthStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryYydGroupMsgMonthStatisticalDataResponseBody
     */
