...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryEmployeeTypeStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryEmployeeTypeStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryEmployeeTypeStatisticalDataResponseBody
     */
