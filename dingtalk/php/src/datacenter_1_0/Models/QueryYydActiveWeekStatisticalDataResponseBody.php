...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryYydActiveWeekStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryYydActiveWeekStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryYydActiveWeekStatisticalDataResponseBody
     */
