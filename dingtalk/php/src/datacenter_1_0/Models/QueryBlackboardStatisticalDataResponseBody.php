...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryBlackboardStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryBlackboardStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryBlackboardStatisticalDataResponseBody
     */
