...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QuerySingleMessageStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QuerySingleMessageStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QuerySingleMessageStatisticalDataResponseBody
     */
