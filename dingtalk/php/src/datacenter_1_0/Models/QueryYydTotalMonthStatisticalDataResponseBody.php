...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryYydTotalMonthStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryYydTotalMonthStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryYydTotalMonthStatisticalDataResponseBody
     */
