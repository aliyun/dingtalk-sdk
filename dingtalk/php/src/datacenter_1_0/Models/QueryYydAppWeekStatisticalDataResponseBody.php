...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryYydAppWeekStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryYydAppWeekStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryYydAppWeekStatisticalDataResponseBody
     */
