...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryDingSendStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryDingSendStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryDingSendStatisticalDataResponseBody
     */
