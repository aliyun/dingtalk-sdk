...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryYydTodoDayStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryYydTodoDayStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryYydTodoDayStatisticalDataResponseBody
     */
