...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryRedEnvelopeReciveStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryRedEnvelopeReciveStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryRedEnvelopeReciveStatisticalDataResponseBody
     */
