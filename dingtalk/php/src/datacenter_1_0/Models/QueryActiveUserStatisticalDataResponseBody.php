...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryActiveUserStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryActiveUserStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryActiveUserStatisticalDataResponseBody
     */
