...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryRedEnvelopeSendStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryRedEnvelopeSendStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryRedEnvelopeSendStatisticalDataResponseBody
     */
