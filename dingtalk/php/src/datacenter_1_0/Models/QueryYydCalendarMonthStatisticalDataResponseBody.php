...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryYydCalendarMonthStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryYydCalendarMonthStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryYydCalendarMonthStatisticalDataResponseBody
     */
