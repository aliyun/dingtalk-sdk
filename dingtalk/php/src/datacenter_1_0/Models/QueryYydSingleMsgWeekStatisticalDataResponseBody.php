...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryYydSingleMsgWeekStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryYydSingleMsgWeekStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryYydSingleMsgWeekStatisticalDataResponseBody
     */
