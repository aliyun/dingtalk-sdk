...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryGroupMessageStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryGroupMessageStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryGroupMessageStatisticalDataResponseBody
     */
