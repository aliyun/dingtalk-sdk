...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryGeneralDataServiceBatchResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryGeneralDataServiceBatchResponseBody extends Model
{
    /**
     * @var mixed[][]
     */
     ...
     * @param array $map
     *
     * @return QueryGeneralDataServiceBatchResponseBody
     */
