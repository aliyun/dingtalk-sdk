...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryGroupLiveStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryGroupLiveStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryGroupLiveStatisticalDataResponseBody
     */
