...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryYydTotalDayStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryYydTotalDayStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryYydTotalDayStatisticalDataResponseBody
     */
