...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryYydActiveDayStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryYydActiveDayStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryYydActiveDayStatisticalDataResponseBody
     */
