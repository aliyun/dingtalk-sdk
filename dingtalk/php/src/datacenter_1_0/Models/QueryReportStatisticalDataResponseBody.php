...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryReportStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryReportStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryReportStatisticalDataResponseBody
     */
