...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryGeneralDataServiceResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryGeneralDataServiceResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryGeneralDataServiceResponseBody
     */
