...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryOnlineUserStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryOnlineUserStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryOnlineUserStatisticalDataResponseBody
     */
