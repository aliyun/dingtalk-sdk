...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryCalendarStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryCalendarStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryCalendarStatisticalDataResponseBody
     */
