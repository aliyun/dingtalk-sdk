...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryDingReciveStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryDingReciveStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryDingReciveStatisticalDataResponseBody
     */
