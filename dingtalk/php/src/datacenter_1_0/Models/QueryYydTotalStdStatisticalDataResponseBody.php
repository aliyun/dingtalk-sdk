...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryYydTotalStdStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryYydTotalStdStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryYydTotalStdStatisticalDataResponseBody
     */
