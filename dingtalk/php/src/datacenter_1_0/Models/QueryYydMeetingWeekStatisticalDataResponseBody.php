...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryYydMeetingWeekStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryYydMeetingWeekStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryYydMeetingWeekStatisticalDataResponseBody
     */
