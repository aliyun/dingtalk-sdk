...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryTodoStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryTodoStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryTodoStatisticalDataResponseBody
     */
