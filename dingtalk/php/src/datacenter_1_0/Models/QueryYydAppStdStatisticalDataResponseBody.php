...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryYydAppStdStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryYydAppStdStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryYydAppStdStatisticalDataResponseBody
     */
