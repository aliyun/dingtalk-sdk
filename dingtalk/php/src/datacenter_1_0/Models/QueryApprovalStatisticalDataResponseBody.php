...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryApprovalStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryApprovalStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryApprovalStatisticalDataResponseBody
     */
