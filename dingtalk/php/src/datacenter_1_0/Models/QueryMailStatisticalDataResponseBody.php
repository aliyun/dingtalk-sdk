...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryMailStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryMailStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryMailStatisticalDataResponseBody
     */
