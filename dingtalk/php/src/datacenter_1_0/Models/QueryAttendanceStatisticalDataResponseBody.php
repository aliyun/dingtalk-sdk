...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryAttendanceStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryAttendanceStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryAttendanceStatisticalDataResponseBody
     */
