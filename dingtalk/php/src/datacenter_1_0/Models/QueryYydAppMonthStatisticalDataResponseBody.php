...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryYydAppMonthStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryYydAppMonthStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryYydAppMonthStatisticalDataResponseBody
     */
