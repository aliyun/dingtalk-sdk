...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryCircleStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryCircleStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryCircleStatisticalDataResponseBody
     */
