...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryYydActiveMonthStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryYydActiveMonthStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryYydActiveMonthStatisticalDataResponseBody
     */
