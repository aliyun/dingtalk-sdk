...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryTelMeetingStatisticalDataResponseBody\metaList;
use AlibabaCloud\Tea\Model;

class QueryTelMeetingStatisticalDataResponseBody extends Model
{
    /**
     * @description 指标数据
     *
     ...
     * @param array $map
     *
     * @return QueryTelMeetingStatisticalDataResponseBody
     */
