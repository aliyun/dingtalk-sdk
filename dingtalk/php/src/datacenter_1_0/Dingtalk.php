...
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryEduUnionAuthServiceHeaders;
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryEduUnionAuthServiceRequest;
use AlibabaCloud\SDK\Dingtalk\Vdatacenter_1_0\Models\QueryEduUnionAuthServiceResponse;
...
class Dingtalk extends OpenApiClient
{
     ...
     * @summary 数据流通中心获取数据服务
     *  *
     * @param DataMarketServiceRequest $request DataMarketServiceRequest
     * @param DataMarketServiceHeaders $headers DataMarketServiceHeaders
     * @param RuntimeOptions           $runtime runtime options for this request RuntimeOptions
     *
     * @return DataMarketServiceResponse DataMarketServiceResponse
     */
    public function dataMarketServiceWithOptions($request, $headers, $runtime)
    {
        Utils::validateModel($request);
        $body = [];
        if (!Utils::isUnset($request->apiId)) {
     ...
     * @return DataMarketServiceResponse DataMarketServiceResponse
     */
    public function dataMarketService($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = new DataMarketServiceHeaders([]);
    ...
    /**
     * @summary 教育组织上下游授权信息查询服务
     *  *
     * @param QueryEduUnionAuthServiceRequest $request QueryEduUnionAuthServiceRequest
     * @param QueryEduUnionAuthServiceHeaders $headers QueryEduUnionAuthServiceHeaders
     * @param RuntimeOptions                  $runtime runtime options for this request RuntimeOptions
     *
     * @return QueryEduUnionAuthServiceResponse QueryEduUnionAuthServiceResponse
     */
    public function queryEduUnionAuthServiceWithOptions($request, $headers, $runtime)
    {
        Utils::validateModel($request);
        $query = [];
        ...
        return QueryEduUnionAuthServiceResponse::fromMap($this->execute($params, $req, $runtime));
    }
     ...
     * @return QueryEduUnionAuthServiceResponse QueryEduUnionAuthServiceResponse
     */
    public function queryEduUnionAuthService($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = new QueryEduUnionAuthServiceHeaders([]);
