...
class Dingtalk extends OpenApiClient
{
    ...
    public function checkInCrowdsByMobileWithOptions($request, $headers, $runtime)
    {
        ...
        return CheckInCrowdsByMobileResponse::fromMap($this->doROARequestWithForm($params->action, $params->version, $params->protocol, $params->method, $params->authType, $params->pathname, $params->bodyType, $req, $runtime));
    }
