...
use AlibabaCloud\SDK\Dingtalk\Vhrm_1_0\Models\MasterDataDeleteResponseBody\failResult;
use AlibabaCloud\Tea\Model;

class MasterDataDeleteResponseBody extends Model
{
    /**
     ...
     * @param array $map
     *
     * @return MasterDataDeleteResponseBody
     */
