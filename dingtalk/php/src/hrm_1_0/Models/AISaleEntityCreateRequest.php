...
use AlibabaCloud\SDK\Dingtalk\Vhrm_1_0\Models\AISaleEntityCreateRequest\fieldInstances;
use AlibabaCloud\Tea\Model;

class AISaleEntityCreateRequest extends Model
{
    /**
     * @var string
     */
     ...
     * @param array $map
     *
     * @return AISaleEntityCreateRequest
     */
