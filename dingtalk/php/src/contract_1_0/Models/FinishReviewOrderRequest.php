...
use AlibabaCloud\SDK\Dingtalk\Vcontract_1_0\Models\FinishReviewOrderRequest\endFiles;
use AlibabaCloud\Tea\Model;

class FinishReviewOrderRequest extends Model
{
    /**
     * @var endFiles[]
     */
     ...
     * @param array $map
     *
     * @return FinishReviewOrderRequest
     */
