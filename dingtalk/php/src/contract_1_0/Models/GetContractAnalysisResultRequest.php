...
use AlibabaCloud\SDK\Dingtalk\Vcontract_1_0\Models\GetContractAnalysisResultRequest\fileInfo;
use AlibabaCloud\Tea\Model;

class GetContractAnalysisResultRequest extends Model
{
    /**
     * @var fileInfo
     */
     ...
     * @param array $map
     *
     * @return GetContractAnalysisResultRequest
     */
