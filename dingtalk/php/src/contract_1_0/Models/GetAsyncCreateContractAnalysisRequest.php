...
use AlibabaCloud\SDK\Dingtalk\Vcontract_1_0\Models\GetAsyncCreateContractAnalysisRequest\fileInfo;
use AlibabaCloud\Tea\Model;

class GetAsyncCreateContractAnalysisRequest extends Model
{
    /**
     * @var fileInfo
     */
     ...
     * @param array $map
     *
     * @return GetAsyncCreateContractAnalysisRequest
     */
