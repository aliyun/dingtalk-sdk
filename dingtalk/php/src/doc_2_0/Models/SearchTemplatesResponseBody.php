...
use AlibabaCloud\SDK\Dingtalk\Vdoc_2_0\Models\SearchTemplatesResponseBody\templateList;
use AlibabaCloud\Tea\Model;

class SearchTemplatesResponseBody extends Model
{
    /**
     * @example next_token
     *
     ...
     * @param array $map
     *
     * @return SearchTemplatesResponseBody
     */
