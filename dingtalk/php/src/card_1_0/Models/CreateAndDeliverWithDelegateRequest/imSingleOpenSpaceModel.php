...
use AlibabaCloud\SDK\Dingtalk\Vcard_1_0\Models\CreateAndDeliverWithDelegateRequest\imSingleOpenSpaceModel\searchSupport;
use AlibabaCloud\Tea\Model;

class imSingleOpenSpaceModel extends Model
{
    /**
     * @var string[]
     */
