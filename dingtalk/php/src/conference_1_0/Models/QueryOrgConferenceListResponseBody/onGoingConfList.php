...
namespace AlibabaCloud\SDK\Dingtalk\Vconference_1_0\Models\QueryOrgConferenceListResponseBody;

use AlibabaCloud\Tea\Model;

class onGoingConfList extends Model
{
    /**
     * @var string
     */
