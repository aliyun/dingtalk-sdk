...
use AlibabaCloud\SDK\Dingtalk\Vcalendar_1_0\Models\GetScheduleByMeResponseBody\scheduleInformation;
use AlibabaCloud\Tea\Model;

class GetScheduleByMeResponseBody extends Model
{
    /**
     ...
     * @param array $map
     *
     * @return GetScheduleByMeResponseBody
     */
