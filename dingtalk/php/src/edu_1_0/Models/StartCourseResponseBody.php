...
use AlibabaCloud\SDK\Dingtalk\Vedu_1_0\Models\StartCourseResponseBody\universityCourseCommonResponse;
use AlibabaCloud\Tea\Model;

class StartCourseResponseBody extends Model
{
    /**
     ...
     * @param array $map
     *
     * @return StartCourseResponseBody
     */
