...
use AlibabaCloud\SDK\Dingtalk\Vedu_1_0\Models\CallMultimodalModelRequest\chatMessageModelList;
use AlibabaCloud\Tea\Model;

class CallMultimodalModelRequest extends Model
{
    /**
     ...
     * @param array $map
     *
     * @return CallMultimodalModelRequest
     */
