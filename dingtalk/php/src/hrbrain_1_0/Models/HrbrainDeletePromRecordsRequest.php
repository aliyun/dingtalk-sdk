...
use AlibabaCloud\SDK\Dingtalk\Vhrbrain_1_0\Models\HrbrainDeletePromRecordsRequest\params;
use AlibabaCloud\Tea\Model;

class HrbrainDeletePromRecordsRequest extends Model
{
    /**
     * @var params[]
     */
     ...
     * @param array $map
     *
     * @return HrbrainDeletePromRecordsRequest
     */
