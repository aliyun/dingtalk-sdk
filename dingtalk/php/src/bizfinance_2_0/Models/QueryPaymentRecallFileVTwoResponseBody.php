...
use AlibabaCloud\SDK\Dingtalk\Vbizfinance_2_0\Models\QueryPaymentRecallFileVTwoResponseBody\paymentRecallFileList;
use AlibabaCloud\Tea\Model;

class QueryPaymentRecallFileVTwoResponseBody extends Model
{
    /**
     * @var string
     */
     ...
     * @param array $map
     *
     * @return QueryPaymentRecallFileVTwoResponseBody
     */
