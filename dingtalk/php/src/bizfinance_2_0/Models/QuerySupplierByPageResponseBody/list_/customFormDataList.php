...
namespace AlibabaCloud\SDK\Dingtalk\Vbizfinance_2_0\Models\QuerySupplierByPageResponseBody\list_;

use AlibabaCloud\Tea\Model;

class customFormDataList extends Model
{
    /**
     * @var string
     */
