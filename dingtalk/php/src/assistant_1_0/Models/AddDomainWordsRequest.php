...
use AlibabaCloud\SDK\Dingtalk\Vassistant_1_0\Models\AddDomainWordsRequest\domainWords;
use AlibabaCloud\Tea\Model;

class AddDomainWordsRequest extends Model
{
    /**
