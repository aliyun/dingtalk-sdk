...
use AlibabaCloud\SDK\Dingtalk\Vmicro_app_1_0\Models\ListUserVilebleAppResponseBody\appList;
use AlibabaCloud\Tea\Model;

class ListUserVilebleAppResponseBody extends Model
{
    /**
     * @description 应用列表
     *
     ...
     * @param array $map
     *
     * @return ListUserVilebleAppResponseBody
     */
