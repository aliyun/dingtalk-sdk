...
use AlibabaCloud\SDK\Dingtalk\Vmicro_app_1_0\Models\ListAllInnerAppsResponseBody\appList;
use AlibabaCloud\Tea\Model;

class ListAllInnerAppsResponseBody extends Model
{
    /**
     * @description 应用列表
     *
     ...
     * @param array $map
     *
     * @return ListAllInnerAppsResponseBody
     */
