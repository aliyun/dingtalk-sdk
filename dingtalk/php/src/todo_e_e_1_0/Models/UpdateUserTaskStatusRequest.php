...
use AlibabaCloud\SDK\Dingtalk\Vtodo_e_e_1_0\Models\UpdateUserTaskStatusRequest\userTaskStatuses;
use AlibabaCloud\Tea\Model;

class UpdateUserTaskStatusRequest extends Model
{
    /**
     * @var string
     */
     ...
     * @param array $map
     *
     * @return UpdateUserTaskStatusRequest
     */
