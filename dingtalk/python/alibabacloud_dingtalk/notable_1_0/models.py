...
class CopyWorkflowHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class CopyWorkflowRequest(TeaModel):
    def __init__(
        self,
        flow_id: str = None,
    ...
    def to_map(self):
        ...
        if self.flow_version_id is not None:
            result['flowVersionId'] = self.flow_version_id
        if self.is_system is not None:
            result['isSystem'] = self.is_system
        if self.source_base_id is not None:
            result['sourceBaseId'] = self.source_base_id
        if self.operator_id is not None:
            result['operatorId'] = self.operator_id
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('flowVersionId') is not None:
            self.flow_version_id = m.get('flowVersionId')
        if m.get('isSystem') is not None:
            self.is_system = m.get('isSystem')
        if m.get('sourceBaseId') is not None:
            self.source_base_id = m.get('sourceBaseId')
        if m.get('operatorId') is not None:
            self.operator_id = m.get('operatorId')
        return self


class CopyWorkflowResponseBody(TeaModel):
    def __init__(
        self,
        flow_id: str = None,
        success: bool = None,
...
class CopyWorkflowResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CopyWorkflowResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CopyWorkflowResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class DeleteWorkflowHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class DisableWorkflowHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class ExecuteImportRequestAppendConfig(TeaModel):
    def __init__(
        self,
        field_id_mapping: Dict[str, str] = None,
    ...
    def to_map(self):
        ...
        result = dict()
        if self.field_id_mapping is not None:
            result['fieldIdMapping'] = self.field_id_mapping
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('fieldIdMapping') is not None:
            self.field_id_mapping = m.get('fieldIdMapping')
