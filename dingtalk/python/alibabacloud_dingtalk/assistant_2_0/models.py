...
class PageListAICreditsUsageHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class PageListAICreditsUsageRequest(TeaModel):
    def __init__(
        self,
        end_time: str = None,
...
class PageListAICreditsUsageResponseBodyDataList(TeaModel):
    def __init__(
        self,
...
class PageListAICreditsUsageResponseBody(TeaModel):
    def __init__(
        self,
        data_list: List[PageListAICreditsUsageResponseBodyDataList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dataList') is not None:
            for k in m.get('dataList'):
                temp_model = PageListAICreditsUsageResponseBodyDataList()
...
class PageListAICreditsUsageResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: PageListAICreditsUsageResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = PageListAICreditsUsageResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
