...
from alibabacloud_dingtalkesign_1_0 import models as dingtalkesign__1__0_models
...
class Client(OpenApiClient):
    ...
    *\
    ...
    def create_developer_with_options(
        ...
        if not UtilClient.is_unset(request.ding_isv_access_token):
            body['dingIsvAccessToken'] = request.ding_isv_access_token
