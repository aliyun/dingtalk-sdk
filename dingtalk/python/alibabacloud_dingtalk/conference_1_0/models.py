...
class QueryMinutesMeetingResultHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class QueryMinutesMeetingResultRequest(TeaModel):
    def __init__(
        self,
        union_id: str = None,
    ):
...
class QueryMinutesMeetingResultResponseBody(TeaModel):
    def __init__(
        self,
...
class QueryMinutesMeetingResultResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: QueryMinutesMeetingResultResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = QueryMinutesMeetingResultResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class SetSubtitleEventHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class SetSubtitleEventRequest(TeaModel):
    def __init__(
        self,
        enable: bool = None,
    ):
...
class SetSubtitleEventResponseBody(TeaModel):
    def __init__(
        self,
        success: bool = None,
    ):
...
class SetSubtitleEventResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: SetSubtitleEventResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = SetSubtitleEventResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class UpdateMemberNickHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class UpdateMemberNickRequest(TeaModel):
    def __init__(
        self,
        nick: str = None,
        union_id: str = None,
...
class UpdateMemberNickResponseBody(TeaModel):
    def __init__(
        self,
        success: bool = None,
    ):
...
class UpdateMemberNickResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: UpdateMemberNickResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = UpdateMemberNickResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
