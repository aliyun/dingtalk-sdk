...
class ATMDeviceWorkNotifyHeaders(TeaModel):
    def __init__(
        self,
...
class ATMDeviceWorkNotifyRequest(TeaModel):
    def __init__(
        self,
...
class ATMDeviceWorkNotifyResponseBody(TeaModel):
    def __init__(
        self,
        success: bool = None,
    ):
...
class ATMDeviceWorkNotifyResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ATMDeviceWorkNotifyResponseBody = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('body') is not None:
            temp_model = ATMDeviceWorkNotifyResponseBody()
...
class RemoveUserFaceHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class RemoveUserFaceRequest(TeaModel):
    def __init__(
        self,
        user_id: str = None,
    ):
...
class RemoveUserFaceResponseBody(TeaModel):
    def __init__(
        self,
        result: bool = None,
    ):
...
class RemoveUserFaceResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: RemoveUserFaceResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = RemoveUserFaceResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
