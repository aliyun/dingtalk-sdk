...
class ResultUserDeviceStatusMapValueStatus(TeaModel):
    def __init__(
        self,
        value: str = None,
    ):
...
class ResultUserDeviceStatusMapValue(TeaModel):
    def __init__(
        self,
        sn: str = None,
        status: ResultUserDeviceStatusMapValueStatus = None,
    ):
        self.sn = sn
        self.status = status
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('status') is not None:
            temp_model = ResultUserDeviceStatusMapValueStatus()
...
class BatchQueryUserDeviceStatusRequest(TeaModel):
    def __init__(
        self,
...
class BatchQueryUserDeviceStatusResponseBodyResult(TeaModel):
    def __init__(
        self,
        user_device_status_map: Dict[str, List[ResultUserDeviceStatusMapValue]] = None,
    ):
        self.user_device_status_map = user_device_status_map

    def validate(self):
        if self.user_device_status_map:
            for v in self.user_device_status_map.values():
                for k1 in v:
                    if k1:
                        k1.validate()
    ...
    def to_map(self):
        ...
        result = dict()
        result['userDeviceStatusMap'] = {}
        if self.user_device_status_map is not None:
            for k, v in self.user_device_status_map.items():
                l1 = []
                for k1 in v:
                    l1.append(k1.to_map() if k1 else None)
                result['userDeviceStatusMap'][k] = l1
        return result

    def from_map(self, m: dict = None):
        m = m or dict()
        self.user_device_status_map = {}
        if m.get('userDeviceStatusMap') is not None:
            for k, v in m.get('userDeviceStatusMap').items():
                l1 = []
                for k1 in v:
                    temp_model = ResultUserDeviceStatusMapValue()
                    l1.append(temp_model.from_map(k1))
                self.user_device_status_map['k'] = l1
        return self


class BatchQueryUserDeviceStatusResponseBody(TeaModel):
    def __init__(
        self,
        result: BatchQueryUserDeviceStatusResponseBodyResult = None,
    ):
        self.result = result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = BatchQueryUserDeviceStatusResponseBodyResult()
            self.result = temp_model.from_map(m['result'])
        return self


class BatchQueryUserDeviceStatusResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: BatchQueryUserDeviceStatusResponseBody = None,
    ):
...
class ControlRecordingHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class ControlRecordingRequest(TeaModel):
    def __init__(
        self,
        action: str = None,
        agree: bool = None,
...
class ControlRecordingResponseBody(TeaModel):
    def __init__(
        self,
        result: bool = None,
    ):
...
class ControlRecordingResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ControlRecordingResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = ControlRecordingResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class CreateAsrTranscriptionHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class CreateAsrTranscriptionRequest(TeaModel):
    def __init__(
        self,
        biz_key: str = None,
        url: str = None,
...
class CreateAsrTranscriptionResponseBodyResult(TeaModel):
    def __init__(
        self,
        task_id: str = None,
    ):
...
class CreateAsrTranscriptionResponseBody(TeaModel):
    def __init__(
        self,
        result: CreateAsrTranscriptionResponseBodyResult = None,
    ):
        self.result = result
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('result') is not None:
            temp_model = CreateAsrTranscriptionResponseBodyResult()
            self.result = temp_model.from_map(m['result'])
        return self


class CreateAsrTranscriptionResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CreateAsrTranscriptionResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CreateAsrTranscriptionResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class CreateRecordingScheduleHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class CreateRecordingScheduleRequestSchedules(TeaModel):
    def __init__(
        self,
        business_order: str = None,
        end_time: int = None,
        start_time: int = None,
    ):
        # This parameter is required.
    ...
    def to_map(self):
        ...
        result = dict()
        if self.business_order is not None:
            result['businessOrder'] = self.business_order
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('businessOrder') is not None:
            self.business_order = m.get('businessOrder')
...
class CreateRecordingScheduleRequest(TeaModel):
    def __init__(
        self,
        schedules: List[CreateRecordingScheduleRequestSchedules] = None,
        sn: str = None,
    ):
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('schedules') is not None:
            for k in m.get('schedules'):
                temp_model = CreateRecordingScheduleRequestSchedules()
...
class CreateRecordingScheduleResponseBodyResult(TeaModel):
    def __init__(
        self,
        business_order: str = None,
        end_time: int = None,
...
class CreateRecordingScheduleResponseBody(TeaModel):
    def __init__(
        self,
        result: List[CreateRecordingScheduleResponseBodyResult] = None,
    ):
        self.result = result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            for k in m.get('result'):
                temp_model = CreateRecordingScheduleResponseBodyResult()
                self.result.append(temp_model.from_map(k))
        return self


class CreateRecordingScheduleResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CreateRecordingScheduleResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CreateRecordingScheduleResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class DeleteRecordingScheduleResponseBody(TeaModel):
    def __init__(
        self,
        success: bool = None,
    ):
...
class DeleteRecordingScheduleResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: DeleteRecordingScheduleResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
...
class GetAsrTranscriptionHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class GetAsrTranscriptionRequest(TeaModel):
    def __init__(
        self,
...
class GetAsrTranscriptionResponseBodyResultResultInfoParagraphList(TeaModel):
    def __init__(
        self,
        end_time: int = None,
        paragraph: str = None,
...
class GetAsrTranscriptionResponseBodyResultResultInfo(TeaModel):
    def __init__(
        self,
        paragraph_list: List[GetAsrTranscriptionResponseBodyResultResultInfoParagraphList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('paragraphList') is not None:
            for k in m.get('paragraphList'):
                temp_model = GetAsrTranscriptionResponseBodyResultResultInfoParagraphList()
                self.paragraph_list.append(temp_model.from_map(k))
        return self


class GetAsrTranscriptionResponseBodyResult(TeaModel):
    def __init__(
        self,
        biz_key: str = None,
        next_token: str = None,
        result_info: GetAsrTranscriptionResponseBodyResultResultInfo = None,
        task_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('resultInfo') is not None:
            temp_model = GetAsrTranscriptionResponseBodyResultResultInfo()
...
class GetAsrTranscriptionResponseBody(TeaModel):
    def __init__(
        self,
        result: GetAsrTranscriptionResponseBodyResult = None,
    ):
        self.result = result
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('result') is not None:
            temp_model = GetAsrTranscriptionResponseBodyResult()
            self.result = temp_model.from_map(m['result'])
        return self


class GetAsrTranscriptionResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetAsrTranscriptionResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetAsrTranscriptionResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class GetRecordingScheduleHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class GetRecordingScheduleResponseBodyResult(TeaModel):
    def __init__(
        self,
        business_order: str = None,
        end_time: int = None,
...
class GetRecordingScheduleResponseBody(TeaModel):
    def __init__(
        self,
        result: GetRecordingScheduleResponseBodyResult = None,
    ):
        self.result = result
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('result') is not None:
            temp_model = GetRecordingScheduleResponseBodyResult()
            self.result = temp_model.from_map(m['result'])
        return self


class GetRecordingScheduleResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetRecordingScheduleResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetRecordingScheduleResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class GetServiceRecordHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class GetServiceRecordRequest(TeaModel):
    def __init__(
        self,
        id: str = None,
    ):
...
class GetServiceRecordResponseBodyResultUser(TeaModel):
    def __init__(
        self,
        name: str = None,
        user_id: str = None,
...
class GetServiceRecordResponseBodyResult(TeaModel):
    def __init__(
        self,
        customer_id: str = None,
        device_sn: str = None,
    ...
    def to_map(self):
        ...
        if self.out_biz_data is not None:
            result['outBizData'] = self.out_biz_data
        if self.quality_inspection_score is not None:
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('outBizData') is not None:
            self.out_biz_data = m.get('outBizData')
        if m.get('qualityInspectionScore') is not None:
        ...
        if m.get('team') is not None:
            temp_model = GetServiceRecordResponseBodyResultTeam()
            self.team = temp_model.from_map(m['team'])
        if m.get('user') is not None:
            temp_model = GetServiceRecordResponseBodyResultUser()
...
class GetServiceRecordResponseBody(TeaModel):
    def __init__(
        self,
        result: GetServiceRecordResponseBodyResult = None,
    ):
        self.result = result
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('result') is not None:
            temp_model = GetServiceRecordResponseBodyResult()
            self.result = temp_model.from_map(m['result'])
        return self


class GetServiceRecordResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetServiceRecordResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetServiceRecordResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class ListDeviceRecordingDurationHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class ListDeviceRecordingDurationRequest(TeaModel):
    def __init__(
        self,
        end_time: int = None,
        max_results: int = None,
...
class ListDeviceRecordingDurationResponseBody(TeaModel):
    def __init__(
        self,
        next_token: str = None,
        result: List[ListDeviceRecordingDurationResponseBodyResult] = None,
        total_count: int = None,
    ):
        self.next_token = next_token
        self.result = result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            for k in m.get('result'):
                temp_model = ListDeviceRecordingDurationResponseBodyResult()
                self.result.append(temp_model.from_map(k))
        if m.get('totalCount') is not None:
            self.total_count = m.get('totalCount')
        return self
...
class ListDeviceRecordingDurationResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ListDeviceRecordingDurationResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = ListDeviceRecordingDurationResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class ListTeamResponseBodyResultTagListValueList(TeaModel):
    def __init__(
        self,
        code: str = None,
        name: str = None,
...
class ListTeamResponseBodyResultTagList(TeaModel):
    def __init__(
        self,
        code: str = None,
        name: str = None,
        value_list: List[ListTeamResponseBodyResultTagListValueList] = None,
    ):
        self.code = code
        self.name = name
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('valueList') is not None:
            for k in m.get('valueList'):
                temp_model = ListTeamResponseBodyResultTagListValueList()
...
class ListTeamResponseBodyResult(TeaModel):
    def __init__(
        ...
        code: str = None,
        name: str = None,
        tag_list: List[ListTeamResponseBodyResultTagList] = None,
    ):
        self.code = code
        self.name = name
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('tagList') is not None:
            for k in m.get('tagList'):
                temp_model = ListTeamResponseBodyResultTagList()
...
class QueryFileInfoByMinutesIdHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class QueryFileInfoByMinutesIdRequest(TeaModel):
    def __init__(
        self,
        minutes_id: str = None,
    ):
...
class QueryFileInfoByMinutesIdResponseBodyResult(TeaModel):
    def __init__(
        self,
        attributes: Dict[str, Any] = None,
        create_time: int = None,
...
class QueryFileInfoByMinutesIdResponseBody(TeaModel):
    def __init__(
        self,
        result: QueryFileInfoByMinutesIdResponseBodyResult = None,
    ):
        self.result = result
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('result') is not None:
            temp_model = QueryFileInfoByMinutesIdResponseBodyResult()
            self.result = temp_model.from_map(m['result'])
        return self


class QueryFileInfoByMinutesIdResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: QueryFileInfoByMinutesIdResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = QueryFileInfoByMinutesIdResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class QueryUserDeviceLocationRequest(TeaModel):
    def __init__(
        self,
        end_time: int = None,
        sn: str = None,
...
class QueryUserDeviceLocationResponseBodyResultDeviceLocationsLocations(TeaModel):
    def __init__(
        self,
        latitude: str = None,
        longitude: str = None,
...
class QueryUserDeviceLocationResponseBodyResultDeviceLocations(TeaModel):
    def __init__(
        self,
        locations: List[QueryUserDeviceLocationResponseBodyResultDeviceLocationsLocations] = None,
        sn: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('locations') is not None:
            for k in m.get('locations'):
                temp_model = QueryUserDeviceLocationResponseBodyResultDeviceLocationsLocations()
...
class QueryUserDeviceLocationResponseBodyResult(TeaModel):
    def __init__(
        self,
        device_locations: List[QueryUserDeviceLocationResponseBodyResultDeviceLocations] = None,
    ):
        self.device_locations = device_locations

    def validate(self):
        if self.device_locations:
            for k in self.device_locations:
                if k:
                    k.validate()
    ...
    def to_map(self):
        ...
        result = dict()
        result['deviceLocations'] = []
        if self.device_locations is not None:
            for k in self.device_locations:
                result['deviceLocations'].append(k.to_map() if k else None)
        return result

    def from_map(self, m: dict = None):
        m = m or dict()
        self.device_locations = []
        if m.get('deviceLocations') is not None:
            for k in m.get('deviceLocations'):
                temp_model = QueryUserDeviceLocationResponseBodyResultDeviceLocations()
                self.device_locations.append(temp_model.from_map(k))
        return self


class QueryUserDeviceLocationResponseBody(TeaModel):
    def __init__(
        self,
        result: QueryUserDeviceLocationResponseBodyResult = None,
    ):
        self.result = result
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('result') is not None:
            temp_model = QueryUserDeviceLocationResponseBodyResult()
            self.result = temp_model.from_map(m['result'])
        return self


class QueryUserDeviceLocationResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: QueryUserDeviceLocationResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = QueryUserDeviceLocationResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class SubmitAgentTaskHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class SubmitAgentTaskRequest(TeaModel):
    def __init__(
        self,
        agent_code: str = None,
        biz_identify: str = None,
        input: str = None,
        user_id: str = None,
    ):
        # This parameter is required.
        ...
        # This parameter is required.
        self.biz_identify = biz_identify
        # This parameter is required.
        self.input = input
        self.user_id = user_id
    ...
    def to_map(self):
        ...
        if self.biz_identify is not None:
            result['bizIdentify'] = self.biz_identify
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('bizIdentify') is not None:
            self.biz_identify = m.get('bizIdentify')
...
class SubmitAgentTaskResponseBodyResult(TeaModel):
    def __init__(
        self,
        task_id: str = None,
    ):
...
class SubmitAgentTaskResponseBody(TeaModel):
    def __init__(
        self,
        result: SubmitAgentTaskResponseBodyResult = None,
    ):
        self.result = result
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('result') is not None:
            temp_model = SubmitAgentTaskResponseBodyResult()
            self.result = temp_model.from_map(m['result'])
        return self


class SubmitAgentTaskResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: SubmitAgentTaskResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = SubmitAgentTaskResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class SubmitCustomerSplitDataHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class SubmitCustomerSplitDataRequest(TeaModel):
    def __init__(
        self,
        split_params: List[SubmitCustomerSplitDataRequestSplitParams] = None,
        user_id: str = None,
    ):
        # This parameter is required.
    ...
    def to_map(self):
        ...
        if self.split_params is not None:
            for k in self.split_params:
                result['splitParams'].append(k.to_map() if k else None)
        if self.user_id is not None:
            result['userId'] = self.user_id
        return result
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        self.split_params = []
        if m.get('splitParams') is not None:
            for k in m.get('splitParams'):
                temp_model = SubmitCustomerSplitDataRequestSplitParams()
                self.split_params.append(temp_model.from_map(k))
        if m.get('userId') is not None:
            self.user_id = m.get('userId')
        return self


class SubmitCustomerSplitDataShrinkRequest(TeaModel):
    def __init__(
        self,
        split_params_shrink: str = None,
        user_id: str = None,
    ):
        # This parameter is required.
        self.split_params_shrink = split_params_shrink
        # This parameter is required.
        self.user_id = user_id
    ...
    def to_map(self):
        ...
        result = dict()
        if self.split_params_shrink is not None:
            result['splitParams'] = self.split_params_shrink
        if self.user_id is not None:
            result['userId'] = self.user_id
        return result
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('splitParams') is not None:
            self.split_params_shrink = m.get('splitParams')
        if m.get('userId') is not None:
            self.user_id = m.get('userId')
        return self


class SubmitCustomerSplitDataResponseBodyResult(TeaModel):
    def __init__(
        self,
        request_id: str = None,
    ):
...
class SubmitCustomerSplitDataResponseBody(TeaModel):
    def __init__(
        self,
        error_msg: str = None,
        result: SubmitCustomerSplitDataResponseBodyResult = None,
        success: bool = None,
    ):
        self.error_msg = error_msg
        self.result = result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('errorMsg') is not None:
            self.error_msg = m.get('errorMsg')
        if m.get('result') is not None:
            temp_model = SubmitCustomerSplitDataResponseBodyResult()
            self.result = temp_model.from_map(m['result'])
        if m.get('success') is not None:
            self.success = m.get('success')
        return self
...
class SubmitCustomerSplitDataResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: SubmitCustomerSplitDataResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = SubmitCustomerSplitDataResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class UpdateDeviceBindingHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class UpdateDeviceBindingRequest(TeaModel):
    def __init__(
        self,
        action: str = None,
        sn: str = None,
...
class UpdateDeviceBindingResponseBody(TeaModel):
    def __init__(
        self,
        result: bool = None,
    ):
...
class UpdateDeviceBindingResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: UpdateDeviceBindingResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = UpdateDeviceBindingResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class UpdateRecordingScheduleHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class UpdateRecordingScheduleRequest(TeaModel):
    def __init__(
        self,
        end_time: int = None,
        start_time: int = None,
...
class UpdateRecordingScheduleResponseBody(TeaModel):
    def __init__(
        self,
        success: bool = None,
    ):
...
class UpdateRecordingScheduleResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: UpdateRecordingScheduleResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
