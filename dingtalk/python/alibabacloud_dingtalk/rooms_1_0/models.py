...
class SendCentralControlHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class SendCentralControlRequest(TeaModel):
    def __init__(
        self,
    ...
    def to_map(self):
        ...
        result = dict()
        if self.control_body is not None:
            result['controlBody'] = self.control_body
        if self.room_id is not None:
            result['roomId'] = self.room_id
        if self.union_id is not None:
            result['unionId'] = self.union_id
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('controlBody') is not None:
            self.control_body = m.get('controlBody')
        if m.get('roomId') is not None:
            self.room_id = m.get('roomId')
        if m.get('unionId') is not None:
            self.union_id = m.get('unionId')
...
class SendCentralControlResponseBody(TeaModel):
    def __init__(
        self,
        result: bool = None,
    ):
...
class SendCentralControlResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: SendCentralControlResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = SendCentralControlResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
