...
class Client(OpenApiClient):
    ...
    *\
    ...
    def get_blackboard_with_options(
        self,
        request: dingtalkblackboard__1__0_models.GetBlackboardRequest,
        headers: dingtalkblackboard__1__0_models.GetBlackboardHeaders,
        runtime: util_models.RuntimeOptions,
    ) -> dingtalkblackboard__1__0_models.GetBlackboardResponse:
        """
        @summary 获取公告详情
        ...
        params = open_api_models.Params(
            ...
            protocol='HTTP',
            pathname=f'/v1.0/blackboard/get_blackboard',
            method='GET',
            auth_type='AK',
            style='ROA',
            req_body_type='none',
    ...
    async def get_blackboard_with_options_async(
        self,
        request: dingtalkblackboard__1__0_models.GetBlackboardRequest,
        headers: dingtalkblackboard__1__0_models.GetBlackboardHeaders,
        runtime: util_models.RuntimeOptions,
    ...
    def get_blackboard(
        ...
        runtime = util_models.RuntimeOptions()
        headers = dingtalkblackboard__1__0_models.GetBlackboardHeaders()
        return self.get_blackboard_with_options(request, headers, runtime)

    async def get_blackboard_async(
        self,
        request: dingtalkblackboard__1__0_models.GetBlackboardRequest,
    ) -> dingtalkblackboard__1__0_models.GetBlackboardResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = dingtalkblackboard__1__0_models.GetBlackboardHeaders()
        return await self.get_blackboard_with_options_async(request, headers, runtime)
