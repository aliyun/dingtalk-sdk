...
class MapValue(TeaModel):
    def __init__(
        self,
        template_id: str = None,
        title: str = None,
        type: int = None,
        cover_download_url: str = None,
        description: str = None,
        ...
        self.belong = belong
        self.content_download_url = content_download_url
    ...
    def to_map(self):
        ...
        if self.type is not None:
            result['type'] = self.type
        if self.cover_download_url is not None:
            result['coverDownloadUrl'] = self.cover_download_url
        if self.description is not None:
            result['description'] = self.description
        ...
        if self.content_download_url is not None:
            result['contentDownloadUrl'] = self.content_download_url
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('type') is not None:
            self.type = m.get('type')
        if m.get('coverDownloadUrl') is not None:
            self.cover_download_url = m.get('coverDownloadUrl')
        if m.get('description') is not None:
            self.description = m.get('description')
        ...
        if m.get('contentDownloadUrl') is not None:
            self.content_download_url = m.get('contentDownloadUrl')
        return self


class BatchCreateTeamHeaders(TeaModel):
    def __init__(
        self,
...
class BatchCreateTeamRequestParamCreateTeamParamList(TeaModel):
    def __init__(
        self,
        admin_union_id_list: List[str] = None,
    ...
    def to_map(self):
        ...
        result = dict()
        if self.admin_union_id_list is not None:
            result['adminUnionIdList'] = self.admin_union_id_list
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('adminUnionIdList') is not None:
            self.admin_union_id_list = m.get('adminUnionIdList')
...
class BatchCreateTeamRequestParam(TeaModel):
    def __init__(
        self,
    ...
    def to_map(self):
        ...
        if self.create_team_param_list is not None:
            for k in self.create_team_param_list:
                result['createTeamParamList'].append(k.to_map() if k else None)
        return result

    def from_map(self, m: dict = None):
        m = m or dict()
        self.create_team_param_list = []
        if m.get('createTeamParamList') is not None:
            for k in m.get('createTeamParamList'):
                temp_model = BatchCreateTeamRequestParamCreateTeamParamList()
                self.create_team_param_list.append(temp_model.from_map(k))
        return self


class BatchCreateTeamRequest(TeaModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('param') is not None:
            temp_model = BatchCreateTeamRequestParam()
...
class BatchCreateTeamResponseBody(TeaModel):
    def __init__(
        self,
        success: bool = None,
    ):
...
class BatchCreateTeamResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: BatchCreateTeamResponseBody = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('body') is not None:
            temp_model = BatchCreateTeamResponseBody()
...
class CategoriesTemplatesHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class CategoriesTemplatesRequestOption(TeaModel):
    def __init__(
        self,
        category_status: int = None,
        query_platform: str = None,
        size: int = None,
        template_status: int = None,
    ):
        self.category_status = category_status
        self.query_platform = query_platform
        self.size = size
    ...
    def to_map(self):
        ...
        result = dict()
        if self.category_status is not None:
            result['categoryStatus'] = self.category_status
        if self.query_platform is not None:
            result['queryPlatform'] = self.query_platform
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('categoryStatus') is not None:
            self.category_status = m.get('categoryStatus')
        if m.get('queryPlatform') is not None:
            self.query_platform = m.get('queryPlatform')
...
class CategoriesTemplatesRequestParam(TeaModel):
    def __init__(
        self,
...
class CategoriesTemplatesRequest(TeaModel):
    def __init__(
        self,
        option: CategoriesTemplatesRequestOption = None,
        param: CategoriesTemplatesRequestParam = None,
        operator_id: str = None,
    ):
        self.option = option
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('option') is not None:
            temp_model = CategoriesTemplatesRequestOption()
            self.option = temp_model.from_map(m['option'])
        if m.get('param') is not None:
            temp_model = CategoriesTemplatesRequestParam()
            self.param = temp_model.from_map(m['param'])
        if m.get('operatorId') is not None:
            self.operator_id = m.get('operatorId')
        return self
...
class CategoriesTemplatesResponseBody(TeaModel):
    def __init__(
        self,
        map: Dict[str, List[MapValue]] = None,
    ):
        self.map = map
...
class CategoriesTemplatesResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CategoriesTemplatesResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CategoriesTemplatesResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class CategoryTemplatesHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class CategoryTemplatesRequestOption(TeaModel):
    def __init__(
        self,
        category_status: int = None,
        template_status: int = None,
...
class CategoryTemplatesRequestParam(TeaModel):
    def __init__(
        self,
...
class CategoryTemplatesRequest(TeaModel):
    def __init__(
        self,
        option: CategoryTemplatesRequestOption = None,
        param: CategoryTemplatesRequestParam = None,
        operator_id: str = None,
    ):
        self.option = option
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('option') is not None:
            temp_model = CategoryTemplatesRequestOption()
            self.option = temp_model.from_map(m['option'])
        if m.get('param') is not None:
            temp_model = CategoryTemplatesRequestParam()
            self.param = temp_model.from_map(m['param'])
        if m.get('operatorId') is not None:
            self.operator_id = m.get('operatorId')
        return self
...
class CategoryTemplatesResponseBodyList(TeaModel):
    def __init__(
        self,
        author_name: str = None,
        belong: str = None,
...
class CategoryTemplatesResponseBody(TeaModel):
    def __init__(
        self,
        list: List[CategoryTemplatesResponseBodyList] = None,
    ):
        self.list = list
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('list') is not None:
            for k in m.get('list'):
                temp_model = CategoryTemplatesResponseBodyList()
                self.list.append(temp_model.from_map(k))
        return self


class CategoryTemplatesResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CategoryTemplatesResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CategoryTemplatesResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class CopyDocWithAppAuthHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class CopyDocWithAppAuthRequest(TeaModel):
    def __init__(
        self,
        operator_id: str = None,
        source_dentry_uuid: str = None,
...
class CopyDocWithAppAuthResponseBodySyncCopyResultSpaceInfo(TeaModel):
    def __init__(
        self,
        scene_type: str = None,
    ):
...
class CopyDocWithAppAuthResponseBodySyncCopyResult(TeaModel):
    def __init__(
        self,
        dentry_uuid: str = None,
        drive_dentry_id: str = None,
        ...
        extension: str = None,
        name: str = None,
        space_info: CopyDocWithAppAuthResponseBodySyncCopyResultSpaceInfo = None,
        url: str = None,
    ):
        self.dentry_uuid = dentry_uuid
        self.drive_dentry_id = drive_dentry_id
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('name') is not None:
            self.name = m.get('name')
        if m.get('spaceInfo') is not None:
            temp_model = CopyDocWithAppAuthResponseBodySyncCopyResultSpaceInfo()
            self.space_info = temp_model.from_map(m['spaceInfo'])
        if m.get('url') is not None:
            self.url = m.get('url')
        return self
...
class CopyDocWithAppAuthResponseBody(TeaModel):
    def __init__(
        self,
        is_async: bool = None,
        sync_copy_result: CopyDocWithAppAuthResponseBodySyncCopyResult = None,
        task_id: str = None,
    ):
        self.is_async = is_async
        self.sync_copy_result = sync_copy_result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('isAsync') is not None:
            self.is_async = m.get('isAsync')
        if m.get('syncCopyResult') is not None:
            temp_model = CopyDocWithAppAuthResponseBodySyncCopyResult()
            self.sync_copy_result = temp_model.from_map(m['syncCopyResult'])
        if m.get('taskId') is not None:
            self.task_id = m.get('taskId')
        return self
...
class CopyDocWithAppAuthResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CopyDocWithAppAuthResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CopyDocWithAppAuthResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class CopyWorkspaceRequestParam(TeaModel):
    def __init__(
        self,
        origin_workspace_id: str = None,
    ):
        self.origin_workspace_id = origin_workspace_id
    ...
    def to_map(self):
        ...
        if self.origin_workspace_id is not None:
            result['originWorkspaceId'] = self.origin_workspace_id
        return result

    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('originWorkspaceId') is not None:
            self.origin_workspace_id = m.get('originWorkspaceId')
        return self


class CopyWorkspaceRequest(TeaModel):
    def __init__(
        self,
        param: CopyWorkspaceRequestParam = None,
    ):
        # This parameter is required.
        self.param = param
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('param') is not None:
            temp_model = CopyWorkspaceRequestParam()
            self.param = temp_model.from_map(m['param'])
        return self


class CopyWorkspaceResponseBody(TeaModel):
    def __init__(
        self,
        success: bool = None,
    ):
...
class CopyWorkspaceResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CopyWorkspaceResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CopyWorkspaceResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class CopyWorkspaceAsyncHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class CopyWorkspaceAsyncRequestParam(TeaModel):
    def __init__(
        self,
        origin_workspace_id: str = None,
    ):
...
class CopyWorkspaceAsyncRequest(TeaModel):
    def __init__(
        self,
        param: CopyWorkspaceAsyncRequestParam = None,
    ):
        # This parameter is required.
        self.param = param
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('param') is not None:
            temp_model = CopyWorkspaceAsyncRequestParam()
            self.param = temp_model.from_map(m['param'])
        return self


class CopyWorkspaceAsyncResponseBody(TeaModel):
    def __init__(
        self,
        id: int = None,
    ):
...
class CopyWorkspaceAsyncResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CopyWorkspaceAsyncResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CopyWorkspaceAsyncResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class CreateShortcutForMigrateHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class CreateShortcutForMigrateRequest(TeaModel):
    def __init__(
        self,
        operator_id: str = None,
        source_resource_id: str = None,
...
class CreateShortcutForMigrateResponseBodyOpenDentryInfo(TeaModel):
    def __init__(
        self,
        dentry_uuid: str = None,
        drive_dentry_id: str = None,
...
class CreateShortcutForMigrateResponseBody(TeaModel):
    def __init__(
        self,
        open_dentry_info: CreateShortcutForMigrateResponseBodyOpenDentryInfo = None,
    ):
        self.open_dentry_info = open_dentry_info
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('openDentryInfo') is not None:
            temp_model = CreateShortcutForMigrateResponseBodyOpenDentryInfo()
            self.open_dentry_info = temp_model.from_map(m['openDentryInfo'])
        return self


class CreateShortcutForMigrateResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CreateShortcutForMigrateResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CreateShortcutForMigrateResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class CrossOrgMigrateHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class CrossOrgMigrateRequestOption(TeaModel):
    def __init__(
        self,
        check_operator_source_role: bool = None,
        delete_source: bool = None,
        need_recycle_failed_workspace_id: bool = None,
        relate_team_id: int = None,
        relate_team_id_str: str = None,
        retain_org_group: bool = None,
        skip_role: bool = None,
        workspace_id_strs: List[str] = None,
        workspace_ids: List[int] = None,
    ):
        self.check_operator_source_role = check_operator_source_role
        self.delete_source = delete_source
        self.need_recycle_failed_workspace_id = need_recycle_failed_workspace_id
        self.relate_team_id = relate_team_id
        self.relate_team_id_str = relate_team_id_str
        self.retain_org_group = retain_org_group
        self.skip_role = skip_role
    ...
    def to_map(self):
        ...
        result = dict()
        if self.check_operator_source_role is not None:
            result['checkOperatorSourceRole'] = self.check_operator_source_role
        if self.delete_source is not None:
            result['deleteSource'] = self.delete_source
        if self.need_recycle_failed_workspace_id is not None:
            result['needRecycleFailedWorkspaceId'] = self.need_recycle_failed_workspace_id
        if self.relate_team_id is not None:
            result['relateTeamId'] = self.relate_team_id
        if self.relate_team_id_str is not None:
            result['relateTeamIdStr'] = self.relate_team_id_str
        if self.retain_org_group is not None:
            result['retainOrgGroup'] = self.retain_org_group
        if self.skip_role is not None:
            result['skipRole'] = self.skip_role
        if self.workspace_id_strs is not None:
            result['workspaceIdStrs'] = self.workspace_id_strs
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('checkOperatorSourceRole') is not None:
            self.check_operator_source_role = m.get('checkOperatorSourceRole')
        if m.get('deleteSource') is not None:
            self.delete_source = m.get('deleteSource')
        if m.get('needRecycleFailedWorkspaceId') is not None:
            self.need_recycle_failed_workspace_id = m.get('needRecycleFailedWorkspaceId')
        if m.get('relateTeamId') is not None:
            self.relate_team_id = m.get('relateTeamId')
        if m.get('relateTeamIdStr') is not None:
            self.relate_team_id_str = m.get('relateTeamIdStr')
        if m.get('retainOrgGroup') is not None:
            self.retain_org_group = m.get('retainOrgGroup')
        if m.get('skipRole') is not None:
            self.skip_role = m.get('skipRole')
        if m.get('workspaceIdStrs') is not None:
            self.workspace_id_strs = m.get('workspaceIdStrs')
        if m.get('workspaceIds') is not None:
            self.workspace_ids = m.get('workspaceIds')
        return self


class CrossOrgMigrateRequestParam(TeaModel):
    def __init__(
        self,
        corp_id: str = None,
    ):
...
class CrossOrgMigrateRequest(TeaModel):
    def __init__(
        self,
        option: CrossOrgMigrateRequestOption = None,
        param: CrossOrgMigrateRequestParam = None,
        operator_id: str = None,
    ):
        self.option = option
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('option') is not None:
            temp_model = CrossOrgMigrateRequestOption()
            self.option = temp_model.from_map(m['option'])
        if m.get('param') is not None:
            temp_model = CrossOrgMigrateRequestParam()
            self.param = temp_model.from_map(m['param'])
        if m.get('operatorId') is not None:
            self.operator_id = m.get('operatorId')
        return self
...
class CrossOrgMigrateResponseBody(TeaModel):
    def __init__(
        self,
        success: bool = None,
    ):
...
class CrossOrgMigrateResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CrossOrgMigrateResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CrossOrgMigrateResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class DocContentHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class DocContentRequestOption(TeaModel):
    def __init__(
        self,
...
class DocContentRequest(TeaModel):
    def __init__(
        self,
        option: DocContentRequestOption = None,
        operator_id: str = None,
    ):
        self.option = option
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('option') is not None:
            temp_model = DocContentRequestOption()
            self.option = temp_model.from_map(m['option'])
        if m.get('operatorId') is not None:
            self.operator_id = m.get('operatorId')
        return self
...
class DocContentResponseBody(TeaModel):
    def __init__(
        self,
        task_id: int = None,
    ):
...
class DocContentResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: DocContentResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = DocContentResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class DocExportByDelegatedPermissionHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class DocExportByDelegatedPermissionRequest(TeaModel):
    def __init__(
        self,
...
class DocExportByDelegatedPermissionResponseBody(TeaModel):
    def __init__(
        self,
        task_id: int = None,
    ):
...
class DocExportByDelegatedPermissionResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: DocExportByDelegatedPermissionResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = DocExportByDelegatedPermissionResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class DocUpdateContentWithDelegatedPermissionHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class DocUpdateContentWithDelegatedPermissionRequest(TeaModel):
    def __init__(
        self,
        content: str = None,
        data_type: str = None,
...
class DocUpdateContentWithDelegatedPermissionResponseBody(TeaModel):
    def __init__(
        self,
...
class DocUpdateContentWithDelegatedPermissionResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: DocUpdateContentWithDelegatedPermissionResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = DocUpdateContentWithDelegatedPermissionResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class ExportDocHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class ExportDocRequestParam(TeaModel):
    def __init__(
        self,
        dentry_uuid: str = None,
...
class ExportDocRequest(TeaModel):
    def __init__(
        self,
        param: ExportDocRequestParam = None,
    ):
        # This parameter is required.
        self.param = param
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('param') is not None:
            temp_model = ExportDocRequestParam()
            self.param = temp_model.from_map(m['param'])
        return self


class ExportDocResponseBody(TeaModel):
    def __init__(
        self,
        job_id: str = None,
        status: str = None,
...
class ExportDocResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ExportDocResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = ExportDocResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class GetDentryIdByUuidHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class GetDentryIdByUuidRequest(TeaModel):
    def __init__(
        self,
        operator_id: str = None,
    ):
...
class GetDentryIdByUuidResponseBody(TeaModel):
    def __init__(
        self,
        dentry_id: str = None,
        dentry_uuid: str = None,
...
class GetDentryIdByUuidResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetDentryIdByUuidResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetDentryIdByUuidResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class GetDocContentForELMHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class GetDocContentForELMRequest(TeaModel):
    def __init__(
        self,
        target_format: str = None,
    ):
...
class GetDocContentForELMResponseBody(TeaModel):
    def __init__(
        self,
        task_id: int = None,
    ):
...
class GetDocContentForELMResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetDocContentForELMResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetDocContentForELMResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class GetMySpaceHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class GetMySpaceRequest(TeaModel):
    def __init__(
        self,
        is_my_space: bool = None,
    ):
        self.is_my_space = is_my_space
    ...
    def to_map(self):
        ...
        result = dict()
        if self.is_my_space is not None:
            result['isMySpace'] = self.is_my_space
        return result

    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('isMySpace') is not None:
            self.is_my_space = m.get('isMySpace')
        return self


class GetMySpaceResponseBody(TeaModel):
    def __init__(
        self,
        create_time: str = None,
...
class GetMySpaceResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetMySpaceResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetMySpaceResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class GetOrgOrWebOpenDocContentHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class GetOrgOrWebOpenDocContentRequest(TeaModel):
    def __init__(
        self,
        generate_cp: bool = None,
        scope_type: int = None,
...
class GetOrgOrWebOpenDocContentResponseBody(TeaModel):
    def __init__(
        self,
        task_id: int = None,
    ):
...
class GetOrgOrWebOpenDocContentResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetOrgOrWebOpenDocContentResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetOrgOrWebOpenDocContentResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class GetUuidByDentryIdHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class GetUuidByDentryIdRequest(TeaModel):
    def __init__(
        self,
        operator_id: str = None,
        space_id: str = None,
...
class GetUuidByDentryIdResponseBody(TeaModel):
    def __init__(
        self,
        dentry_id: str = None,
        dentry_uuid: str = None,
...
class GetUuidByDentryIdResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetUuidByDentryIdResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetUuidByDentryIdResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class GetUuidByIdOrUrlHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class GetUuidByIdOrUrlRequest(TeaModel):
    def __init__(
        self,
        id_or_url: str = None,
        operator_id: str = None,
    ...
    def to_map(self):
        ...
        result = dict()
        if self.id_or_url is not None:
            result['idOrUrl'] = self.id_or_url
        if self.operator_id is not None:
            result['operatorId'] = self.operator_id
        return result
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('idOrUrl') is not None:
            self.id_or_url = m.get('idOrUrl')
        if m.get('operatorId') is not None:
            self.operator_id = m.get('operatorId')
        return self


class GetUuidByIdOrUrlResponseBody(TeaModel):
    def __init__(
        self,
        dentry_uuid: str = None,
    ):
...
class GetUuidByIdOrUrlResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetUuidByIdOrUrlResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetUuidByIdOrUrlResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class HandoverTeamWithoutAuthRequestParam(TeaModel):
    def __init__(
        self,
        leave: bool = None,
        new_owner: str = None,
...
class HandoverTeamWithoutAuthRequest(TeaModel):
    def __init__(
        self,
        param: HandoverTeamWithoutAuthRequestParam = None,
    ):
        # This parameter is required.
        self.param = param
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('param') is not None:
            temp_model = HandoverTeamWithoutAuthRequestParam()
            self.param = temp_model.from_map(m['param'])
        return self


class HandoverTeamWithoutAuthResponseBody(TeaModel):
    def __init__(
        self,
        success: bool = None,
    ):
...
class HandoverTeamWithoutAuthResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: HandoverTeamWithoutAuthResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
...
class ListRecentsRequestParam(TeaModel):
    def __init__(
        self,
...
class ListRecentsRequest(TeaModel):
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('param') is not None:
            temp_model = ListRecentsRequestParam()
            self.param = temp_model.from_map(m['param'])
        return self
...
class LockDocRequestParam(TeaModel):
    def __init__(
        self,
        dentry_uuid: str = None,
        name: str = None,
...
class LockDocRequest(TeaModel):
    def __init__(
        self,
        param: LockDocRequestParam = None,
    ):
        # This parameter is required.
        self.param = param
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('param') is not None:
            temp_model = LockDocRequestParam()
            self.param = temp_model.from_map(m['param'])
        return self


class LockDocResponseBody(TeaModel):
    def __init__(
        self,
        success: bool = None,
    ):
...
class LockDocResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: LockDocResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = LockDocResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class LockDocByDelegatedPermissionHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class LockDocByDelegatedPermissionRequestParam(TeaModel):
    def __init__(
        self,
        dentry_uuid: str = None,
        name: str = None,
...
class LockDocByDelegatedPermissionRequest(TeaModel):
    def __init__(
        self,
        param: LockDocByDelegatedPermissionRequestParam = None,
    ):
        # This parameter is required.
        self.param = param
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('param') is not None:
            temp_model = LockDocByDelegatedPermissionRequestParam()
            self.param = temp_model.from_map(m['param'])
        return self


class LockDocByDelegatedPermissionResponseBody(TeaModel):
    def __init__(
        self,
        success: bool = None,
    ):
...
class LockDocByDelegatedPermissionResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: LockDocByDelegatedPermissionResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = LockDocByDelegatedPermissionResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class QueryDocContentHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class QueryDocContentRequest(TeaModel):
    def __init__(
        self,
        operator_id: str = None,
        target_format: str = None,
...
class QueryDocContentResponseBody(TeaModel):
    def __init__(
        self,
        task_id: int = None,
    ):
...
class QueryDocContentResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: QueryDocContentResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = QueryDocContentResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class QueryExportTaskHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class QueryExportTaskRequest(TeaModel):
    def __init__(
        self,
        operator_id: str = None,
        task_id: str = None,
...
class QueryExportTaskResponseBody(TeaModel):
    def __init__(
        self,
...
class QueryExportTaskResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: QueryExportTaskResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = QueryExportTaskResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class QueryGetContentJobHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class QueryGetContentJobRequest(TeaModel):
    def __init__(
        self,
        operator_id: str = None,
        task_id: int = None,
...
class QueryGetContentJobResponseBody(TeaModel):
    def __init__(
        self,
...
class QueryGetContentJobResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: QueryGetContentJobResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = QueryGetContentJobResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class SearchTemplatesHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class SearchTemplatesRequestOption(TeaModel):
    def __init__(
        self,
        exclude_workspace_ids: List[str] = None,
        max_results: int = None,
        next_token: str = None,
        platform: str = None,
        template_types: List[int] = None,
        version: int = None,
        workspace_ids: List[str] = None,
    ):
        self.exclude_workspace_ids = exclude_workspace_ids
        self.max_results = max_results
        self.next_token = next_token
    ...
    def to_map(self):
        ...
        result = dict()
        if self.exclude_workspace_ids is not None:
            result['excludeWorkspaceIds'] = self.exclude_workspace_ids
        if self.max_results is not None:
            result['maxResults'] = self.max_results
        if self.next_token is not None:
            result['nextToken'] = self.next_token
        ...
        if self.template_types is not None:
            result['templateTypes'] = self.template_types
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('excludeWorkspaceIds') is not None:
            self.exclude_workspace_ids = m.get('excludeWorkspaceIds')
        if m.get('maxResults') is not None:
            self.max_results = m.get('maxResults')
        if m.get('nextToken') is not None:
            self.next_token = m.get('nextToken')
        ...
        if m.get('templateTypes') is not None:
            self.template_types = m.get('templateTypes')
...
class SearchTemplatesRequestParam(TeaModel):
    def __init__(
        self,
        belong: str = None,
...
class SearchTemplatesRequest(TeaModel):
    def __init__(
        self,
        option: SearchTemplatesRequestOption = None,
        param: SearchTemplatesRequestParam = None,
        operator_id: str = None,
    ):
        self.option = option
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('option') is not None:
            temp_model = SearchTemplatesRequestOption()
            self.option = temp_model.from_map(m['option'])
        if m.get('param') is not None:
            temp_model = SearchTemplatesRequestParam()
            self.param = temp_model.from_map(m['param'])
        if m.get('operatorId') is not None:
            self.operator_id = m.get('operatorId')
        return self
...
class SearchTemplatesResponseBodyTemplateList(TeaModel):
    def __init__(
        self,
        author_name: str = None,
        belong: str = None,
...
class SearchTemplatesResponseBody(TeaModel):
    def __init__(
        self,
        next_token: str = None,
        template_list: List[SearchTemplatesResponseBodyTemplateList] = None,
    ):
        self.next_token = next_token
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('templateList') is not None:
            for k in m.get('templateList'):
                temp_model = SearchTemplatesResponseBodyTemplateList()
                self.template_list.append(temp_model.from_map(k))
        return self


class SearchTemplatesResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: SearchTemplatesResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = SearchTemplatesResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class ShareUrlHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class ShareUrlRequestParam(TeaModel):
    def __init__(
        self,
        dentry_uuid: str = None,
    ...
    def to_map(self):
        ...
        if self.dentry_uuid is not None:
            result['dentryUuid'] = self.dentry_uuid
        if self.trigger_share is not None:
            result['triggerShare'] = self.trigger_share
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dentryUuid') is not None:
            self.dentry_uuid = m.get('dentryUuid')
        if m.get('triggerShare') is not None:
            self.trigger_share = m.get('triggerShare')
        return self


class ShareUrlRequest(TeaModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('param') is not None:
            temp_model = ShareUrlRequestParam()
            self.param = temp_model.from_map(m['param'])
        return self


class ShareUrlResponseBodyShareUrlInfo(TeaModel):
    def __init__(
        self,
        mobile_url: str = None,
        pc_url: str = None,
...
class ShareUrlResponseBody(TeaModel):
    def __init__(
        self,
        share_url_info: ShareUrlResponseBodyShareUrlInfo = None,
    ):
        self.share_url_info = share_url_info

    def validate(self):
        if self.share_url_info:
            self.share_url_info.validate()
    ...
    def to_map(self):
        ...
        result = dict()
        if self.share_url_info is not None:
            result['shareUrlInfo'] = self.share_url_info.to_map()
        return result

    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('shareUrlInfo') is not None:
            temp_model = ShareUrlResponseBodyShareUrlInfo()
            self.share_url_info = temp_model.from_map(m['shareUrlInfo'])
        return self


class ShareUrlResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ShareUrlResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = ShareUrlResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class SubmitExportJobHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class SubmitExportJobRequest(TeaModel):
    def __init__(
        self,
        dentry_uuid: str = None,
        operator_id: str = None,
...
class SubmitExportJobResponseBody(TeaModel):
    def __init__(
        self,
        download_url: str = None,
        task_id: str = None,
...
class SubmitExportJobResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: SubmitExportJobResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = SubmitExportJobResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class SubmitGetContentJobHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class SubmitGetContentJobRequest(TeaModel):
    def __init__(
        self,
        operator_id: str = None,
        target_format: str = None,
...
class SubmitGetContentJobResponseBody(TeaModel):
    def __init__(
        self,
        task_id: int = None,
    ):
...
class SubmitGetContentJobResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: SubmitGetContentJobResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = SubmitGetContentJobResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class TeamTemplatesHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class TeamTemplatesRequestOption(TeaModel):
    def __init__(
        self,
        exclude_workspace_ids: List[str] = None,
        max_results: int = None,
...
class TeamTemplatesRequest(TeaModel):
    def __init__(
        self,
        option: TeamTemplatesRequestOption = None,
        operator_id: str = None,
    ):
        self.option = option
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('option') is not None:
            temp_model = TeamTemplatesRequestOption()
            self.option = temp_model.from_map(m['option'])
        if m.get('operatorId') is not None:
            self.operator_id = m.get('operatorId')
        return self
...
class TeamTemplatesResponseBodyTemplateList(TeaModel):
    def __init__(
        self,
        author_name: str = None,
        belong: str = None,
...
class TeamTemplatesResponseBody(TeaModel):
    def __init__(
        self,
        next_token: str = None,
        template_list: List[TeamTemplatesResponseBodyTemplateList] = None,
    ):
        self.next_token = next_token
        self.template_list = template_list
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('templateList') is not None:
            for k in m.get('templateList'):
                temp_model = TeamTemplatesResponseBodyTemplateList()
                self.template_list.append(temp_model.from_map(k))
        return self


class TeamTemplatesResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: TeamTemplatesResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = TeamTemplatesResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class TemplateCategoriesHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class TemplateCategoriesRequestOption(TeaModel):
    def __init__(
        self,
        category_status: int = None,
...
class TemplateCategoriesRequestParam(TeaModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):
...
class TemplateCategoriesRequest(TeaModel):
    def __init__(
        self,
        option: TemplateCategoriesRequestOption = None,
        param: TemplateCategoriesRequestParam = None,
        operator_id: str = None,
    ):
        self.option = option
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('option') is not None:
            temp_model = TemplateCategoriesRequestOption()
            self.option = temp_model.from_map(m['option'])
        if m.get('param') is not None:
            temp_model = TemplateCategoriesRequestParam()
            self.param = temp_model.from_map(m['param'])
        if m.get('operatorId') is not None:
            self.operator_id = m.get('operatorId')
        return self
...
class TemplateCategoriesResponseBodyList(TeaModel):
    def __init__(
        self,
        category_id: str = None,
...
class TemplateCategoriesResponseBody(TeaModel):
    def __init__(
        self,
        list: List[TemplateCategoriesResponseBodyList] = None,
    ):
        self.list = list
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('list') is not None:
            for k in m.get('list'):
                temp_model = TemplateCategoriesResponseBodyList()
                self.list.append(temp_model.from_map(k))
        return self


class TemplateCategoriesResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: TemplateCategoriesResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = TemplateCategoriesResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class UnlockDocHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class UnlockDocRequestParam(TeaModel):
    def __init__(
        self,
        dentry_uuid: str = None,
        operator_uid: str = None,
...
class UnlockDocRequest(TeaModel):
    def __init__(
        self,
        param: UnlockDocRequestParam = None,
    ):
        # This parameter is required.
        self.param = param
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('param') is not None:
            temp_model = UnlockDocRequestParam()
            self.param = temp_model.from_map(m['param'])
        return self


class UnlockDocResponseBody(TeaModel):
    def __init__(
        self,
        success: bool = None,
    ):
...
class UnlockDocResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: UnlockDocResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = UnlockDocResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class UnlockDocByDelegatedPermissionHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class UnlockDocByDelegatedPermissionRequestParam(TeaModel):
    def __init__(
        self,
        dentry_uuid: str = None,
    ):
...
class UnlockDocByDelegatedPermissionRequest(TeaModel):
    def __init__(
        self,
        param: UnlockDocByDelegatedPermissionRequestParam = None,
    ):
        # This parameter is required.
        self.param = param
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('param') is not None:
            temp_model = UnlockDocByDelegatedPermissionRequestParam()
            self.param = temp_model.from_map(m['param'])
        return self


class UnlockDocByDelegatedPermissionResponseBody(TeaModel):
    def __init__(
        self,
        success: bool = None,
    ):
...
class UnlockDocByDelegatedPermissionResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: UnlockDocByDelegatedPermissionResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = UnlockDocByDelegatedPermissionResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class UserTemplatesHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class UserTemplatesRequestOption(TeaModel):
    def __init__(
        self,
        max_results: int = None,
        next_token: str = None,
...
class UserTemplatesRequest(TeaModel):
    def __init__(
        self,
        option: UserTemplatesRequestOption = None,
        operator_id: str = None,
    ):
        self.option = option
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('option') is not None:
            temp_model = UserTemplatesRequestOption()
            self.option = temp_model.from_map(m['option'])
        if m.get('operatorId') is not None:
            self.operator_id = m.get('operatorId')
        return self
...
class UserTemplatesResponseBodyTemplateList(TeaModel):
    def __init__(
        self,
        author_name: str = None,
        belong: str = None,
...
class UserTemplatesResponseBody(TeaModel):
    def __init__(
        self,
        next_token: str = None,
        template_list: List[UserTemplatesResponseBodyTemplateList] = None,
    ):
        self.next_token = next_token
        self.template_list = template_list
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('templateList') is not None:
            for k in m.get('templateList'):
                temp_model = UserTemplatesResponseBodyTemplateList()
                self.template_list.append(temp_model.from_map(k))
        return self


class UserTemplatesResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: UserTemplatesResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = UserTemplatesResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
