    ...
    *\
    ...
    def get_relation_uk_setting_with_options(
        ...
        return TeaCore.from_map(
            dingtalkcrm__2__0_models.GetRelationUkSettingResponse(),
            self.do_roarequest('GetRelationUkSetting', 'crm_2.0', 'HTTP', 'GET', 'AK', f'/v2.0/crm/relationUkSettings', 'json', req, runtime)
        )
    ...
    async def get_relation_uk_setting_with_options_async(
        ...
        return TeaCore.from_map(
            dingtalkcrm__2__0_models.GetRelationUkSettingResponse(),
            await self.do_roarequest_async('GetRelationUkSetting', 'crm_2.0', 'HTTP', 'GET', 'AK', f'/v2.0/crm/relationUkSettings', 'json', req, runtime)
        )
