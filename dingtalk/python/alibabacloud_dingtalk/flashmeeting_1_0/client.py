...
class Client(OpenApiClient):
    ...
    *\
    ...
    def get_shanhui_attachments_with_options(
        self,
        request: dingtalkflashmeeting__1__0_models.GetShanhuiAttachmentsRequest,
        headers: dingtalkflashmeeting__1__0_models.GetShanhuiAttachmentsHeaders,
        runtime: util_models.RuntimeOptions,
    ) -> dingtalkflashmeeting__1__0_models.GetShanhuiAttachmentsResponse:
        """
        @summary 获取闪会内上传的附件
        ...
        params = open_api_models.Params(
            ...
            version='flashmeeting_1.0',
            protocol='HTTP',
            pathname=f'/v1.0/flashmeeting/meetings/getShanhuiAttachments',
            method='POST',
            auth_type='AK',
            style='ROA',
            req_body_type='none',
    ...
    async def get_shanhui_attachments_with_options_async(
        self,
        request: dingtalkflashmeeting__1__0_models.GetShanhuiAttachmentsRequest,
        headers: dingtalkflashmeeting__1__0_models.GetShanhuiAttachmentsHeaders,
        runtime: util_models.RuntimeOptions,
    ...
    def get_shanhui_attachments(
        ...
        runtime = util_models.RuntimeOptions()
        headers = dingtalkflashmeeting__1__0_models.GetShanhuiAttachmentsHeaders()
        return self.get_shanhui_attachments_with_options(request, headers, runtime)

    async def get_shanhui_attachments_async(
        self,
        request: dingtalkflashmeeting__1__0_models.GetShanhuiAttachmentsRequest,
    ) -> dingtalkflashmeeting__1__0_models.GetShanhuiAttachmentsResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = dingtalkflashmeeting__1__0_models.GetShanhuiAttachmentsHeaders()
        return await self.get_shanhui_attachments_with_options_async(request, headers, runtime)
