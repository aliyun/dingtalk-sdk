    ...
    *\
    ...
    def open_connection_with_options(
        ...
        return TeaCore.from_map(
            dingtalkgateway__1__0_models.OpenConnectionResponse(),
            self.do_roarequest('OpenConnection', 'gateway_1.0', 'HTTP', 'POST', 'AK', f'/v1.0/gateway/connections/open', 'json', req, runtime)
        )
    ...
    async def open_connection_with_options_async(
        ...
        return TeaCore.from_map(
            dingtalkgateway__1__0_models.OpenConnectionResponse(),
            await self.do_roarequest_async('OpenConnection', 'gateway_1.0', 'HTTP', 'POST', 'AK', f'/v1.0/gateway/connections/open', 'json', req, runtime)
        )
