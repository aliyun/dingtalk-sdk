...
class Client(OpenApiClient):
    ...
    *\
    ...
    def update_robot_stream_away_auto_reply_template_with_options(
        self,
        request: dingtalkrobot__1__0_models.UpdateRobotStreamAwayAutoReplyTemplateRequest,
        headers: dingtalkrobot__1__0_models.UpdateRobotStreamAwayAutoReplyTemplateHeaders,
        runtime: util_models.RuntimeOptions,
    ) -> dingtalkrobot__1__0_models.UpdateRobotStreamAwayAutoReplyTemplateResponse:
        """
        ...
        params = open_api_models.Params(
            ...
            version='robot_1.0',
            protocol='HTTP',
            pathname=f'/v1.0/robot/stream/away/template/update',
            method='POST',
            auth_type='AK',
            style='ROA',
            req_body_type='none',
    ...
    async def update_robot_stream_away_auto_reply_template_with_options_async(
        self,
        request: dingtalkrobot__1__0_models.UpdateRobotStreamAwayAutoReplyTemplateRequest,
        headers: dingtalkrobot__1__0_models.UpdateRobotStreamAwayAutoReplyTemplateHeaders,
        runtime: util_models.RuntimeOptions,
    ...
    def update_robot_stream_away_auto_reply_template(
        self,
        request: dingtalkrobot__1__0_models.UpdateRobotStreamAwayAutoReplyTemplateRequest,
    ) -> dingtalkrobot__1__0_models.UpdateRobotStreamAwayAutoReplyTemplateResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = dingtalkrobot__1__0_models.UpdateRobotStreamAwayAutoReplyTemplateHeaders()
        return self.update_robot_stream_away_auto_reply_template_with_options(request, headers, runtime)

    async def update_robot_stream_away_auto_reply_template_async(
        self,
        request: dingtalkrobot__1__0_models.UpdateRobotStreamAwayAutoReplyTemplateRequest,
    ) -> dingtalkrobot__1__0_models.UpdateRobotStreamAwayAutoReplyTemplateResponse:
        """
        ...
        runtime = util_models.RuntimeOptions()
        headers = dingtalkrobot__1__0_models.UpdateRobotStreamAwayAutoReplyTemplateHeaders()
        return await self.update_robot_stream_away_auto_reply_template_with_options_async(request, headers, runtime)
