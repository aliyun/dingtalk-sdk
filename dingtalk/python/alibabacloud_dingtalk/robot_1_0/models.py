...
class UpdateRobotStreamAwayAutoReplyTemplateHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class UpdateRobotStreamAwayAutoReplyTemplateRequest(TeaModel):
    def __init__(
        self,
        card_data: str = None,
...
class UpdateRobotStreamAwayAutoReplyTemplateResponseBody(TeaModel):
    def __init__(
        self,
        success: bool = None,
    ):
...
class UpdateRobotStreamAwayAutoReplyTemplateResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: UpdateRobotStreamAwayAutoReplyTemplateResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = UpdateRobotStreamAwayAutoReplyTemplateResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
