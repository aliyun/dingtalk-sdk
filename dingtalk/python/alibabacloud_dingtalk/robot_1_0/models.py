...
class AddOrgRobotInstanceToGroupHeaders(TeaModel):
    def __init__(
        self,
...
class AddOrgRobotInstanceToGroupRequest(TeaModel):
    def __init__(
        self,
...
class AddOrgRobotInstanceToGroupResponseBody(TeaModel):
    def __init__(
        self,
        result: bool = None,
    ):
...
class AddOrgRobotInstanceToGroupResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: AddOrgRobotInstanceToGroupResponseBody = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('body') is not None:
            temp_model = AddOrgRobotInstanceToGroupResponseBody()
...
class DeleteCustomRobotHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class DeleteCustomRobotRequest(TeaModel):
    def __init__(
        self,
...
class DeleteCustomRobotResponseBody(TeaModel):
    def __init__(
        self,
        result: bool = None,
    ):
...
class DeleteCustomRobotResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: DeleteCustomRobotResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = DeleteCustomRobotResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class EnableCustomRobotHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class EnableCustomRobotRequest(TeaModel):
    def __init__(
        self,
        action_type: str = None,
        send_notification: bool = None,
...
class EnableCustomRobotResponseBody(TeaModel):
    def __init__(
        self,
        result: bool = None,
    ):
...
class EnableCustomRobotResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: EnableCustomRobotResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = EnableCustomRobotResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class QueryRobotInstanceInGroupInfoHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class QueryRobotInstanceInGroupInfoRequest(TeaModel):
    def __init__(
        self,
        max_result: int = None,
        next_token: str = None,
...
class QueryRobotInstanceInGroupInfoResponseBody(TeaModel):
    def __init__(
        self,
        has_more: bool = None,
        next_token: str = None,
...
class QueryRobotInstanceInGroupInfoResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: QueryRobotInstanceInGroupInfoResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = QueryRobotInstanceInGroupInfoResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class UpdateCustomRobotOutgoingHeaders(TeaModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        x_acs_dingtalk_access_token: str = None,
...
class UpdateCustomRobotOutgoingRequest(TeaModel):
    def __init__(
        self,
...
class UpdateCustomRobotOutgoingResponseBody(TeaModel):
    def __init__(
        self,
...
class UpdateCustomRobotOutgoingResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: UpdateCustomRobotOutgoingResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = UpdateCustomRobotOutgoingResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
